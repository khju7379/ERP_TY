...
{
    public partial class TYERGB021P : TYBase, IPopupHelper
    {
            ...
            : base()
        {
            ...
            this.FormClosing += new FormClosingEventHandler(TYERGB021P_FormClosing);
            this.PreLoad += new System.EventHandler(TYERGB021P_PreLoad);
            this._favorItem.Click += new EventHandler(_favorItem_Click);
        }

        private void TYERGB021P_PreLoad(object sender, System.EventArgs e)
        {
            //this._isShow = true;
        }

        private void TYERGB021P_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void TYERGB021P_Load(object sender, System.EventArgs e)
        {
            if (this.DesignMode)
                return;

            if (this.FPS91_TY_S_GB_66AHL149.CurrentContextMenu.Items.IndexOf(this._favorItem) < 0)
            {
                this.FPS91_TY_S_GB_66AHL149.CurrentContextMenu.Items.Insert(0, new ToolStripSeparator());
                this.FPS91_TY_S_GB_66AHL149.CurrentContextMenu.Items.Insert(0, this._favorItem);
            }
            ...
            if (this._TComboHelper != null)
            {
                ...
                if (string.IsNullOrEmpty(this._TComboHelper.GetText()) ^ string.IsNullOrEmpty(this._TComboHelper.GetValue().ToString()))
                    this.SetStartingFocus(this.FPS91_TY_S_GB_66AHL149);
                else
        ...
        private void BTN61_INQ_Click(object sender, System.EventArgs e)
        {
            ...
            switch (this.CBO02_CODE_SCH_TYPE.GetValue().ToString())
            {
                ...
                case "3":   //최근등록순
                    if (ds.Tables["LIST"].Columns.IndexOf("REG_DTM") < 0)
                    {
                        ...
                        this.FPS91_TY_S_GB_66AHL149.SetValue(source);
                        return;
                    }
            ...
            if (sender != null && this.FPS91_TY_S_GB_66AHL149.ActiveSheet.Rows.Count > 0)
                this.SetFocus(this.FPS91_TY_S_GB_66AHL149);
        }
        ...
        private void FPS91_TY_S_GB_66AHL149_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            if (e.ColumnHeader)
                return;
        ...
        private void _favorItem_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_GB_2449G388"
                ...
                , "P_TY_P_GB_2A9BT513"
                , "NO CUSTOM PARAM"
                , this.FPS91_TY_S_GB_66AHL149.GetValue(this.FPS91_TY_S_GB_66AHL149.ActiveRowIndex, "CODE").ToString()
        ...
        {
            if (this.FPS91_TY_S_GB_66AHL149.ActiveSheet.Rows.Count == 0)
                return;

            int row = this.FPS91_TY_S_GB_66AHL149.ActiveRowIndex;

            string code = this.FPS91_TY_S_GB_66AHL149.GetValue(row, "CODE").ToString();
            string name = this.FPS91_TY_S_GB_66AHL149.GetValue(row, "CODE_NAME").ToString();

            this._SelectedDataRow = this.FPS91_TY_S_GB_66AHL149.GetDataRow(row);
            if (this._TComboHelper != null)
            {
        ...
        public void ShowPopupHelper()
        {
            ...
            {
                this.TYERGB021P_Load(null, null);
