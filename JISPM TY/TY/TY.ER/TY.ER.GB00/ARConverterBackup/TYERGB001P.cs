...
//using GrapeCity.ActiveReports.Export.Rtf;
using GrapeCity.ActiveReports.Export.Text;
//using GrapeCity.ActiveReports.Export.Tiff;
using GrapeCity.ActiveReports.Export.Excel;
...
namespace TY.ER.GB00
{
    ...
    public partial class TYERGB001P : TYBase
    {
            ...
            : base()
        {
            ...
            this.ABT01_PDF = new GrapeCity.ActiveReports.Toolbar.Button();
            this.ABT01_PDF.ButtonStyle = GrapeCity.ActiveReports.Toolbar.ButtonStyle.Text;
            this.ABT01_PDF.Caption = "Export";
            this.ABT01_PDF.Id = 1;
            this.AVW01_REPORT.Toolbar.Tools.Add(new GrapeCity.ActiveReports.Toolbar.Separator());
        ...
        private class ExportForm : System.Windows.Forms.Form
        {
            ...
            private GrapeCity.ActiveReports.Document doc;
            ...
            public ExportForm(GrapeCity.ActiveReports.SectionReportModel.Section.Document doc)
            {
                InitializeComponent();
