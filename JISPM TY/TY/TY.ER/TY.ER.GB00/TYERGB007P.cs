...
{
    public partial class TYERGB007P : TYBase, IPopupHelper
    {
        ...
        public TYERGB007P() : base()
        {
            InitializeComponent();

            this.SetPopupStyle();

            this.FormClosing += new FormClosingEventHandler(TYERGB007P_FormClosing);
            this.PreLoad += new System.EventHandler(TYERGB007P_PreLoad);
            this._favorItem.Click += new EventHandler(_favorItem_Click);
        }

        private void TYERGB007P_PreLoad(object sender, System.EventArgs e)
        {
            //this._isShow = true;
        }

        private void TYERGB007P_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.SaveSearchCondition();
            //this._isShow = false;
        }

        private void TYERGB007P_Load(object sender, System.EventArgs e)
        {
            if (this.DesignMode)
                return;

            if (this.FPS91_TY_S_AC_25N1V608.CurrentContextMenu.Items.IndexOf(this._favorItem) < 0)
            {
                this.FPS91_TY_S_AC_25N1V608.CurrentContextMenu.Items.Insert(0, new ToolStripSeparator());
                this.FPS91_TY_S_AC_25N1V608.CurrentContextMenu.Items.Insert(0, this._favorItem);
            }
            ...
            if (this._TComboHelper != null)
            {
                ...
                if (string.IsNullOrEmpty(this._TComboHelper.GetText()) ^ string.IsNullOrEmpty(this._TComboHelper.GetValue().ToString()))
                    this.SetStartingFocus(this.FPS91_TY_S_AC_25N1V608);
                else
        ...
        private void BTN61_INQ_Click(object sender, System.EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_AC_25N23609", "BK", this.TXT01_CODE.GetValue(), this.TXT01_CODE_NAME.GetValue());
            ...
            switch (this.CBO02_CODE_SCH_TYPE.GetValue().ToString())
            {
                ...
                case "3":   //최근등록순
                    if (ds.Tables["LIST"].Columns.IndexOf("REG_DTM") < 0)
                    {
                        ...
                        this.FPS91_TY_S_AC_25N1V608.SetValue(source);
                        return;
                    }
            ...
            if (sender != null && this.FPS91_TY_S_AC_25N1V608.ActiveSheet.Rows.Count > 0)
                this.SetFocus(this.FPS91_TY_S_AC_25N1V608);
        }
        ...
        private void FPS91_TY_S_AC_25N1V608_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            if (e.ColumnHeader)
                return;
        ...
        private void _favorItem_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_GB_2449G388"
                ...
                , "P_TY_P_AC_25N23609"
                , "BK"
                , this.FPS91_TY_S_AC_25N1V608.GetValue(this.FPS91_TY_S_AC_25N1V608.ActiveRowIndex, "CODE").ToString()
        ...
        {
            if (this.FPS91_TY_S_AC_25N1V608.ActiveSheet.Rows.Count == 0)
                return;

            int row = this.FPS91_TY_S_AC_25N1V608.ActiveRowIndex;

            string code = this.FPS91_TY_S_AC_25N1V608.GetValue(row, "CODE").ToString();
            string name = this.FPS91_TY_S_AC_25N1V608.GetValue(row, "CODE_NAME").ToString();

            this._SelectedDataRow = this.FPS91_TY_S_AC_25N1V608.GetDataRow(row);
            if (this._TComboHelper != null)
            {
        ...
        {
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_AC_25N23609", "BK", parameters[1], parameters[0]);
        ...
        public void ShowPopupHelper()
        {
            ...
            {
                this.TYERGB007P_Load(null, null);
