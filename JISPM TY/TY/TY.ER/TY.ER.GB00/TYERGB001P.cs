...
using GrapeCity.ActiveReports.Export.Image.Tiff.Section;
using GrapeCity.ActiveReports.Export.Excel.Section;
using GrapeCity.ActiveReports.Export.Word.Section;
using GrapeCity.ActiveReports.Export.Xml.Section;
...
namespace TY.ER.GB00
{
    ...
    /// </summary>
    public partial class TYERGB001P : TYBase
    {
        //DataDynamics.ActiveReports.Toolbar.Button ABT01_PDF;      

        private ToolStripButton ABT01_PDF = new System.Windows.Forms.ToolStripButton();
        private ToolStripSeparator toolsepara = new System.Windows.Forms.ToolStripSeparator();
        ...
        public TYERGB001P(SectionReport activeReport, DataTable source)
            : base()
        {
            InitializeComponent();
            ...
            ABT01_PDF.Click += new EventHandler(ABT01_PDF_Click);

            toolStrip = this.AVW01_REPORT.Toolbar.ToolStrip;
            ABT01_PDF.Text = "Export";
            ABT01_PDF.ToolTipText = "Export";

            int iCnt = toolStrip.Items.Count;

            toolStrip.Items.Insert(iCnt, toolsepara);
            toolStrip.Items.Insert(iCnt+1, ABT01_PDF);
        ...
        public TYERGB001P(SectionReport activeReport)
            : base()
        {
            InitializeComponent();
        ...
        public TYERGB001P(SectionReport activeReport, DataTable source, int width, int height)
        ...
        //private void AVW01_REPORT_ToolClick(object sender, GrapeCity.ActiveReports.Toolbar.ToolClickEventArgs e)
        //{
        ...
        {
            this.AVW01_REPORT.Print(true, true, true);
        }
        ...
        private class ExportForm : System.Windows.Forms.Form
        {
            ...
            private GrapeCity.ActiveReports.Document.SectionDocument doc;
            ...
            public ExportForm(GrapeCity.ActiveReports.Document.SectionDocument doc)
            {
                InitializeComponent();
        ...
        #region ABT01_PDF_Click 이벤트
        private void ABT01_PDF_Click(object sender, EventArgs e)
        {
            (new ExportForm(this.AVW01_REPORT.Document)).ShowDialog();
        }
        #endregion
