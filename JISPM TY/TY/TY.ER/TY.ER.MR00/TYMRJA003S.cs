...
namespace TY.ER.MR00
{
    ...
    public partial class TYMRJA003S : TYBase
    {
        ...
        public TYMRJA003S(string sYEAR, string sSEQ)
        {
            InitializeComponent();
        ...
        private void TYMRJA003S_Load(object sender, System.EventArgs e)
        {
        ...
        private void UP_SET_NewProcess()
        {
            ...
            this.SetStartingFocus(this.CBH01_FXASCLASS.CodeText);
        ...
        private void UP_SET_UpdateProcess()
        {
            ...
            if (CBH01_FXASCLASS.GetValue().ToString().Substring(0, 1) != "2")
            {
                fsTabCtl = "2";
            }
            else
        ...
        private void BTN61_SAV_Click(object sender, EventArgs e)
        {
            ...
            //TAB 생성
            if (CBH01_FXASCLASS.GetValue().ToString().Substring(0,1)  == "2") //건물
            {
                //층별면적 tab 을 만든다
        ...
        private void tabCtl_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (tabCtl.SelectedIndex == 0)  //마스타
            {
                ...
                this.SetFocus(this.CBH01_FXASCLASS); 
            }
        ...
        private void BTN62_SAV_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(this.TXT02_FXSSUBNUM.GetValue().ToString().Trim()))
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    this.DAT11_FXSCHGCODE.SetValue("00");
                    ...
                    this.DbConnector.CommandClear();
                    this.DbConnector.Attach("TY_P_AC_35376599", this.TXT04_FXYEAR.GetValue().ToString(), this.TXT04_FXSEQ.GetValue().ToString(), this.TXT02_FXSSUBNUM.GetValue(),
                                                                this.MTB01_FXGETDATE.GetValue().ToString().Replace("-", ""), "00", "신규취득",
                                                                this.CBH02_FXSBUYCOM.GetValue(), this.TXT02_FXSQTY.GetValue(), this.TXT02_FXSGETAMOUNT.GetValue() ,
                                                                //"0", "", "",
                                                                //"", "", "",
                                                                //"", "", "",
                                                                //"0", "", "", 
        ...
        {           
            ...
            DAT10_FXASCLASS.SetValue(CBH01_FXASCLASS.GetValue());
