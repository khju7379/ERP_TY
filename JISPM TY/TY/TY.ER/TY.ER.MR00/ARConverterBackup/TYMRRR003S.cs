    ...
    public partial class TYMRRR003S : TYBase
    {
        ...
        private void BTN61_PRT_Click(object sender, EventArgs e)
        {
            ...
            if (this.CBO01_RRN1050.GetValue().ToString() == "1")
            {
                ...
                ActiveReport rpt = new TYMRRR0032R(this.DTP01_GSTDATE.GetValue().ToString(), this.DTP01_GEDDATE.GetValue().ToString());
            ...
            else if (this.CBO01_RRN1050.GetValue().ToString() == "2")
            {
                ...
                ActiveReport rpt = new TYMRRR0031R(this.DTP01_GSTDATE.GetValue().ToString(),this.DTP01_GEDDATE.GetValue().ToString());
