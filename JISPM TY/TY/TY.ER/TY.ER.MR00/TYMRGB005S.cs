...
namespace TY.ER.MR00
{
    ...
    ///  GDATE : 일자
    /// </summary>
    public partial class TYMRGB005S : TYBase
    {
        ...
        public TYMRGB005S(string sDATE, string sCDDP, string sCDDPNM)
        {
            InitializeComponent();
        ...
        private void TYMRGB005S_Load(object sender, System.EventArgs e)
        {
        ...
        private void FPS91_TY_S_MR_2B88D215_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                fsYESANNM = this.FPS91_TY_S_MR_2B88D215.GetValue("P1RKAC").ToString();
            }
        }
        #endregion
