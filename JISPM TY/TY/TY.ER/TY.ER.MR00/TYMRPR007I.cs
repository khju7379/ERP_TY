...
namespace TY.ER.MR00
{
    ...
    ///  PRSHISAB : 작업사번
    /// </summary>
    public partial class TYMRPR007I : TYBase
    {
        ...
        public TYMRPR007I()
        {
            ...
            // 구입처
            this.SetSpreadCodeHelper(this.FPS91_TY_S_MR_35T46783, "PRS2000", "KBHANGL", "PRS2000");
        }

        private void TYMRPR007I_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.FPS91_TY_S_MR_35T46783.SetValue(dt1);
            ...
            //// 요청번호
            //sPRSNUM = this.TXT01_PRS1000.GetValue().ToString() + this.TXT01_PRS1010.GetValue().ToString() + this.TXT01_PRS1020.GetValue().ToString() + Set_Fill4(this.TXT01_PRS1030.GetValue().ToString());

            //if (this.CBO01_PRS2010.GetValue().ToString() == "A") // 전체
            //{
            //    sPRS2010 = "";
            //}
            //else
            //{
            //    sPRS2010 = this.CBO01_PRS2010.GetValue().ToString();
            //}
            ...
            //if (dt.Rows.Count > 0)
            //{
            //    this.FPS91_TY_S_MR_35T46783.SetValue(dt);
            //}
            //else
            //{
            //    this.FPS91_TY_S_MR_35T46783.SetValue(dt);
        ...
        private void UP_Mail_Send()
        {
            ...
            // 메일 수신자
            sMailTo = sMailTo.ToString() + "," + "hjyoon@taeyoung.co.kr";
            mess.To = sMailTo.ToString();
            
            if (fsPRS2010.ToString() == "Y")
            {
                mess.Subject = "회계승인 완료 - 요청번호:" + sPRSNUM.ToString();
            }
            else
            {
                mess.Subject = "회계승인 취소 - 요청번호:" + sPRSNUM.ToString();
            }
        ...
        private void BTN61_BATCH_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            // 스프레드에서 등록 할 항목들
            ds.Tables.Add(this.FPS91_TY_S_MR_35T46783.GetDataSourceInclude(TSpread.TActionType.New, "PRS1050", "PRS2000", "PRS2010", "PRS2020"));
        ...
        private void BTN61_PRM10001_Click(object sender, EventArgs e)
        {
            ...
            // 구매요청 코드헬프
            TYMZPR07C1 popup = new TYMZPR07C1(this.TXT01_PRS1000.GetValue().ToString(), sPRS1020.ToString(), sPRS1020.ToString());
        ...
        private void FPS91_TY_S_MR_35T46783_RowInserted(object sender, TSpread.TAlterEventRow e)
        {
            ...
            else
            {
                ...
                this.FPS91_TY_S_MR_35T46783.SetValue(e.RowIndex, "PRS1000", this.TXT01_PRM1000.GetValue().ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(e.RowIndex, "PRS1010", this.TXT01_PRM1010.GetValue().ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(e.RowIndex, "PRS1020", this.TXT01_PRM1020.GetValue().ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(e.RowIndex, "PRS1030", this.TXT01_PRM1030.GetValue().ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(e.RowIndex, "PRS1040", fsPRS1040.ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(e.RowIndex, "PRS1050", DateTime.Now.ToString("yyyyMMdd").ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(e.RowIndex, "PRS2000", sPRS2000.ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(e.RowIndex, "KBHANGL", sKBHANGL.ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(e.RowIndex, "PRS2010", "Y");
            }
        }
        #endregion
        ...
        private void FPS91_TY_S_MR_364AN810_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            else
            {
                ...
                this.FPS91_TY_S_MR_35T46783_Sheet1.AddRows(0, 1);

                this.FPS91_TY_S_MR_35T46783.ActiveSheet.RowHeader.Cells[0, 0].Text = "N";

                this.FPS91_TY_S_MR_35T46783.SetValue(0, "PRS1000", this.TXT01_PRM1000.GetValue().ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(0, "PRS1010", this.TXT01_PRM1010.GetValue().ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(0, "PRS1020", this.TXT01_PRM1020.GetValue().ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(0, "PRS1030", this.TXT01_PRM1030.GetValue().ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(0, "PRS1040", fsPRS1040.ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(0, "PRS1050", DateTime.Now.ToString("yyyyMMdd").ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(0, "PRS2000", sPRS2000.ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(0, "KBHANGL", sKBHANGL.ToString());
                this.FPS91_TY_S_MR_35T46783.SetValue(0, "PRS2010", "Y");
            }

            // 현업결재
            if (this.FPS91_TY_S_MR_364AN810.GetValue("PRM4020").ToString() == "Y")
            {
                this.BTN61_BATCH.Visible = false;
            }
            else
