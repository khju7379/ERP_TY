...
namespace TY.ER.MR00
{
    ...
    ///  GDATE : 일자
    /// </summary>
    public partial class TYMZPR07C1 : TYBase
    {
        ...
        public TYMZPR07C1(string sPRM1000, string sSTPRM1020, string sEDPRM1020)
        {
            InitializeComponent();
        ...
        private void TYMZPR07C1_Load(object sender, System.EventArgs e)
        {
