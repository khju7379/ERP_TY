...
namespace TY.ER.AC00
{
    ...
    /// 
    /// # 프로시저 정보 ####
    ///  TY_P_AC_29PAM277 : K-GAAP 합계잔액시산표
    /// 
    ///  # 스프레드 정보 ####
    ///  TY_S_AC_29PAN280 : K-GAAP 합계잔액시산표
    /// 
    ///  # 알림문자 정보 ####
    ...
    ///  GSTYYMM : 시작년월
    /// </summary>
    public partial class TYACBJ016S : TYBase
    {
        ...
        private void TYACBJ016S_Load(object sender, System.EventArgs e)
        {
            this.FPS91_TY_S_AC_29PAN280_Sheet1.AddColumnHeaderSpanCell(0, 0, 1, 3);
            this.FPS91_TY_S_AC_29PAN280_Sheet1.AddColumnHeaderSpanCell(0, 3, 2, 1);
            this.FPS91_TY_S_AC_29PAN280_Sheet1.AddColumnHeaderSpanCell(0, 4, 1, 3);
            this.FPS91_TY_S_AC_29PAN280_Sheet1.ColumnHeader.Cells[0, 0].Value = "차변";
            this.FPS91_TY_S_AC_29PAN280_Sheet1.ColumnHeader.Cells[0, 3].Value = "계정과목";
            this.FPS91_TY_S_AC_29PAN280_Sheet1.ColumnHeader.Cells[0, 4].Value = "대변";
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.FPS91_TY_S_AC_29PAN280.SetValue(UP_SuTotal_ds(this.DbConnector.ExecuteDataSet()));

            this.SetSpreadSumRow(this.FPS91_TY_S_AC_29PAN280, "A1NMAC", "[합     계]", SumRowType.Total);
        }
        #endregion
        ...
        private void BTN61_PRT_Click(object sender, EventArgs e)
        {
            ...
            SectionReport rpt = new TYACBJ016R();
