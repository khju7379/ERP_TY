...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACSE010R5 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        {
            DATE.Text = Convert.ToString(this.Fields["DATE"].Value).Substring(0, 4) + "년  01월  01일  부터   " +
                        Convert.ToString(this.Fields["DATE"].Value).Substring(0, 4) + "년  " +
                        Convert.ToString(this.Fields["DATE"].Value).Substring(4, 2) + "월  " +
                        Convert.ToString(this.Fields["DATE"].Value).Substring(6, 2) + "일  까지";
        }
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            this.A1NMAC.Font   = new Font("바탕체", 8, FontStyle.Regular);
            this.ANBSCUST.Font = new Font("바탕체", 8, FontStyle.Regular);
            ...
            if (this._totalRowCount == this._iCount) // 마지막 레코드
            {
                ...
                this.ANBSCUST.Visible = false;
                
                this.ANBSRKAC1.Visible  = true;

                this.ANBSRKAC1.Font   = new Font("바탕체", 9, FontStyle.Bold);
        ...
        private void TYACSE010R5_DataInitialize(object sender, EventArgs e)
        {
