...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACBJ032R : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void TYACBJ032R_DataInitialize(object sender, EventArgs e)
        {
        ...
        private void UP_Col_Distinct(int iindex)
        {
            if (iindex == 0)
            {
                txtB4VLMI1.Text = dt.Rows[iindex]["B4VLMI1"].ToString();
                txtB4VLMI1NM.Text = dt.Rows[iindex]["B4VLMI1NM"].ToString();
            }
            else
            {
                if (dt.Rows[iindex - 1]["B4VLMI1"].ToString() != dt.Rows[iindex]["B4VLMI1"].ToString())                    
                {
                    txtB4VLMI1.Text = dt.Rows[iindex]["B4VLMI1"].ToString();
                    txtB4VLMI1NM.Text = dt.Rows[iindex]["B4VLMI1NM"].ToString();
                }
