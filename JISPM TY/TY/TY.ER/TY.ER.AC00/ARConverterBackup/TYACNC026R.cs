...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACNC026R : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            if (dt.Rows[_iCount - 1]["A1ABAC"].ToString() == "소   계")
            {
        ...
        private void TYACNC026R_DataInitialize(object sender, EventArgs e)
        {
