...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACCE0063R : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            if (this._rowCount == 0)
            {
                ...
                this._B7DEID = this.B7DEID.Text;
            }
            else
            {
                // 중복 제거
                if (this._B7DEID == this.B7DEID.Text)
                {
                    this.B7DEID.Text = "";
                }
                else
            ...
            this._A6CRDT = Convert.ToString(this.Fields["A6CRDT"].Value);
            ...
            {
                // 폰트 글자 및 굵기 바꾸기
                this.A6CRDT.Font = new Font("굴림", 10, FontStyle.Bold);
            ...
            {
                // 폰트 글자 및 굵기 바꾸기
                this.A6CRDT.Font = new Font("굴림", 9);
        ...
        private void TYACCE0063R_DataInitialize(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                {
                    if (Convert.ToString(dr["A6CRDT"]) == "거래구분계")
                    {
                        // 현재 레코드
