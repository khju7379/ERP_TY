...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACCE0061R : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            if (this._rowCount == 0)
            {
                ...
                this._B7NOCC = this.B7NOCC.Text;
            }
            else
            {
                // 중복 제거
                if (this._B7NOCC == this.B7NOCC.Text)
                {
                    this.B7NOCC.Text = "";
                }
                else
            ...
            this._B7NOCC = Convert.ToString(this.Fields["B7NOCC"].Value);
            ...
            {
                // 폰트 글자 및 굵기 바꾸기
                this.B7NOCC.Font = new Font("굴림", 10, FontStyle.Bold);
            ...
            {
                // 폰트 글자 및 굵기 바꾸기
                this.B7NOCC.Font = new Font("굴림", 9);
        ...
        private void TYACCE0061R_DataInitialize(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                {
                    if (Convert.ToString(dr["B7NOCC"]) == "소계")
                    {
                        //// 이전 레코드
