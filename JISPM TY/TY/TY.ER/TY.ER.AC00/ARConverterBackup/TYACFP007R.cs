...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACFP007R : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            this.VNSANGHO1.Font = new Font("굴림", 9, FontStyle.Regular);
            this.JAN.Font = new Font("굴림", 9, FontStyle.Regular);

            if (dt.Rows[_iCount - 1]["VNSANGHO"].ToString() == "*** 합 계 ***")
            {
                this.VNSANGHO1.Font = new Font("굴림", 9, FontStyle.Bold);
            ...
            if (dt.Rows[_iCount - 1]["VNSANGHO"].ToString() == "*** 총합계 ***")
            {
                this.VNSANGHO1.Font = new Font("굴림", 9, FontStyle.Bold);
                this.JAN.Font = new Font("굴림", 9, FontStyle.Bold);
            ...
            if (_fiCount != _iCount) 
            {
                if (dt.Rows[_iCount]["VNSANGHO"].ToString() == "*** 합 계 ***")
                {
                    this.line5.Visible = true;
                ...
                if (dt.Rows[_iCount]["VNSANGHO"].ToString() == "*** 총합계 ***")
                {
                    this.line5.Visible = true;
        ...
        private void TYACFP007R_DataInitialize(object sender, EventArgs e)
        {
