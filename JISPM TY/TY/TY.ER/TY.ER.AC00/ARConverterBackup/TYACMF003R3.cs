...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACMF003R3 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void pageHeader_Format(object sender, EventArgs e)
        {
            ...
            txtDATE1.Text = Convert.ToString(this.Fields["DATE"].Value).Substring(0, 4) + "-" +
        ...
        private void TYACMF003R3_DataInitialize(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                //결재라인 사장, 대표사장 표시 
                if (Convert.ToDecimal(dt.Rows[0]["DATE"].ToString()) >= 20201201)
                {
