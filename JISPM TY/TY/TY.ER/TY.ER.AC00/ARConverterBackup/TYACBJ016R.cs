...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACBJ016R : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void TYACBJ016R_DataInitialize(object sender, EventArgs e)
        {
        ...
        private DataTable UP_SuTotal_ds(DataTable ds)
        {
            ...
            if (nNum > 0)
            {
                ...
                foreach (DataRow dr in ds.Select("A1YNTB='Y'", "G2CDAC ASC"))
