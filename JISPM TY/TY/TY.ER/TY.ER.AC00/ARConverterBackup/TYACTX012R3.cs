...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACTX012R3 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public TYACTX012R3(DataTable dt, DataTable dt2, string sYEAR, string sRPTGUBN, string sCONFGB)
        {
            this._dt = dt;
            this._dt2 = dt2;
        ...
        private void TYACTX012R3_ReportStart(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                if (dt.Rows.Count > 5)
                {
                    TYACTX012R4 subReport = new TYACTX012R4();
                    subReport.DataSource = dt;
                    TYACTX012R4.Report = subReport;
                }
            }
        }
