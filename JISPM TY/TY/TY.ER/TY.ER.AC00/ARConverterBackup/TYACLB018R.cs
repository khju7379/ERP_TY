...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACLB018R : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private string _fsJ2NMAC = string.Empty;
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            this.J2CDAC.Font = new Font("굴림", 9, FontStyle.Regular);
            this.J2CDJJ.Font = new Font("굴림", 9, FontStyle.Regular);
            this.J2NMAC.Font = new Font("굴림", 9, FontStyle.Regular);
            this.J1RKAC.Font = new Font("굴림", 9, FontStyle.Regular);
            ...
            if (dt.Rows[_iCount - 1]["J2CDAC"].ToString() == "계 정 계" || dt.Rows[_iCount - 1]["J2CDAC"].ToString() == "부 서 계" ||
                dt.Rows[_iCount - 1]["J2CDAC"].ToString() == "총     계")
            {
                this.J2CDAC.Font = new Font("굴림", 9, FontStyle.Bold);
                this.J2CDJJ.Font = new Font("굴림", 9, FontStyle.Bold);
                this.J2NMAC.Font = new Font("굴림", 9, FontStyle.Bold);
                this.J1RKAC.Font = new Font("굴림", 9, FontStyle.Bold);
            ...
            if (this.J2NMAC.Text == "")
            {
                if (this._rowCount == 0)
                {
                    this.J2NMAC.Text = _fsJ2NMAC;
                }
            }
            else
            {
                _fsJ2NMAC = this.J2NMAC.Text;
            }
            ...
            {
                if (dt.Rows[_iCount - 1]["J2CDAC"].ToString() == "부 서 계")
                {
        ...
        private void TYACLB018R_DataInitialize(object sender, EventArgs e)
        {
