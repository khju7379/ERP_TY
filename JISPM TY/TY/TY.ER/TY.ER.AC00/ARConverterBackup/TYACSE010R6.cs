...
namespace TY.ER.AC00
{
    ...
    public partial class TYACSE010R6 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            this.ANBSSAMT.Font = new Font("바탕체", 8, FontStyle.Regular);
            this.ANBSMAMT.Font = new Font("바탕체", 8, FontStyle.Regular);
            ...
            if (this._totalRowCount == this._iCount) // 마지막 레코드
            {
                ...
                this.ANBSSAMT.Font  = new Font("바탕체", 9, FontStyle.Bold);
                this.ANBSMAMT.Font  = new Font("바탕체", 9, FontStyle.Bold);
