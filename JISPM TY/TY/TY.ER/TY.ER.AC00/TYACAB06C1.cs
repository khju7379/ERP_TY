...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACAB06C1 : TYBase
    {
        private string fsAFVNCODE = string.Empty;
        private string fsAFSEQ = string.Empty;

        private TYData DAT30_AFVNCODE;
        private TYData DAT30_AFSEQ;
        private TYData DAT30_AFDATE;
        ...
        public TYACAB06C1(string sAFVNCODE, string sAFSEQ)
        {
            _fbAttachFile = null;

            fsAFVNCODE = sAFVNCODE;
            fsAFSEQ = sAFSEQ;

            InitializeComponent();

            this.DAT30_AFVNCODE = new TYData("DAT30_AFVNCODE", null);
            this.DAT30_AFSEQ = new TYData("DAT30_AFSEQ", null);
            this.DAT30_AFDATE = new TYData("DAT30_AFDATE", null);
        ...
        {
            this.CBH01_AFVNCODE.SetValue(fsAFVNCODE);
            this.ControlFactory.Add(this.DAT30_AFVNCODE);
            this.ControlFactory.Add(this.DAT30_AFSEQ);
            this.ControlFactory.Add(this.DAT30_AFDATE);
        ...
        private void UP_Run()
        {
            ...
            if (fsAFSEQ != "")
            {
                ...
                this.DbConnector.Attach("TY_P_AC_667AY059", this.fsAFVNCODE, fsAFSEQ);
                DataSet ds = this.DbConnector.ExecuteDataSet();

                if (ds.Tables[0].Rows.Count > 0)
                {
                    this.CBH01_AFVNCODE.SetValue(ds.Tables[0].Rows[0]["AFVNCODE"].ToString());
                    this.TXT01_AFSEQ.SetValue(ds.Tables[0].Rows[0]["AFSEQ"].ToString());
                    this.DTP01_AFDATE.SetValue(ds.Tables[0].Rows[0]["AFDATE"].ToString());
                    ...
                    _fbAttachFile = ds.Tables[0].Rows[0]["AFFILEBYTE"] as byte[];

                    string fileName = "C:\\Temp\\" + TXT01_AFFILENAME.GetValue().ToString();
                    ...
                    string filepath = "C:\\Temp\\" + this.TXT01_AFFILENAME.Text;

                    this.PDF81_AcroPDF.SetValue(filepath);
        ...
        {
            this.CBH01_AFVNCODE.SetValue(this.fsAFVNCODE);
            this.TXT01_AFSEQ.SetValue("");            
            this.DTP01_AFDATE.SetValue(DateTime.Now.ToString("yyyy-MM-dd"));
        ...
        private void BTN61_SAV_Click(object sender, EventArgs e)
        {
            ...
            {
                this.DbConnector.Attach("TY_P_AC_667AW056", this.ControlFactory, "30");
            }
            else                                    //수정
            {
                this.DbConnector.Attach("TY_P_AC_667AX057", this.ControlFactory, "30");
            }
        ...
        private void BTN61_SEARCH_Click(object sender, EventArgs e)
        {
            ...
            if (this.OpenFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                filepath = this.TXT01_ATTACH_FILENAME.Text;
        ...
        private void BTN61_SAV_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            this.DAT30_AFVNCODE.SetValue(this.CBH01_AFVNCODE.GetValue().ToString());
            this.DAT30_AFSEQ.SetValue(this.TXT01_AFSEQ.GetValue());
            this.DAT30_AFDATE.SetValue(this.DTP01_AFDATE.GetValue());
        ...
        {
            string dd = this.CBH01_AFVNCODE.GetValue().ToString();
            ...
            this.DbConnector.Attach
                (
                "TY_P_AC_667B5060",
                this.CBH01_AFVNCODE.GetValue().ToString()
                );
