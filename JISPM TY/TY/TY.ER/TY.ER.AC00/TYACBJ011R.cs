...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACBJ011R : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            if (_iCount - 1 < Retdt.Rows.Count)
            {
                ...
                if (Retdt.Rows[_iCount - 1]["A1CDAC"].ToString() == "43000000" ||
                    Retdt.Rows[_iCount - 1]["A1CDAC"].ToString() == "49000000" ||
        ...
        private void TYACBJ011R_DataInitialize(object sender, EventArgs e)
        {
        ...
        private void reportHeader1_Format(object sender, EventArgs e)
        {
            this.GSTDATE.Text = _fsGSTDATE.ToString();
            this.GEDDATE.Text = _fsGEDDATE.ToString();
            this.CDDPNM.Text = _fsCDDPNM.ToString();
        }
    }
}