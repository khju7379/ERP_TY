...
namespace TY.ER.AC00
{
    ...
    ///  GSTYYMM : 시작년월
    /// </summary>
    public partial class TYACGT003S : TYBase
    {
        ...
        private void TYACGT003S_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                this.FPS91_TY_S_AC_25E4Y431.SetValue(dt);

                // 특정 ROW 색깔 입히기
                for (int i = 0; i < this.FPS91_TY_S_AC_25E4Y431.ActiveSheet.RowCount; i++)
                {
                    if (this.FPS91_TY_S_AC_25E4Y431.GetValue(i, "B4DTAC").ToString() == "")
                    {
                        // 특정 ROW 색깔 입히기
                        this.FPS91_TY_S_AC_25E4Y431.ActiveSheet.Rows[i].BackColor = Color.FromArgb(218, 239, 244);
                    }
                }
            }
            else
        ...
        private void BTN61_PRT_Click(object sender, EventArgs e)
        {
            ...
            SectionReport rpt = new TYACGT003R();
