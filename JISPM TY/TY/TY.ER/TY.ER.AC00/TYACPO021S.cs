...
{
    /// <summary>
    /// EIS 계열사 엑셀자료 처리 프로그램입니다.
    /// 
    /// 작성자 : 김종술
    /// 작성일 : 2013.09.06 10:41
    /// 
    /// =====================================================================================
    ...
    /// 
    /// # 프로시저 정보 ####
    ///  TY_P_AC_3962F585 : EIS 계열사 엑셀자료 처리
    /// 
    ///  # 스프레드 정보 ####
    ...
    ///  EPLCGB : 손익생성
    /// </summary>
    public partial class TYACPO021S : TYBase
    {
        public TYACPO021S()
        {
            InitializeComponent();
        ...
        private void TYACPO021S_Load(object sender, System.EventArgs e)
        {
            ...
            this.FPS91_TY_S_AC_3A159942.Visible = false; // 티와이스틸 매출자료
            this.FPS91_TY_S_AC_3AH5T074.Visible = false; // 차입금 세부
            this.FPS91_TY_S_AC_3AUA9134.Visible = false; // GLS 매출

            this.BTN61_SAV.Visible = false;

            SetStartingFocus(this.CBO01_EPLCGB);
        } 
        #endregion
        ...
        private void BTN61_EXCEL_Click(object sender, EventArgs e)
        {
            ...
            if (this.CBO01_EPLCGB.GetValue().ToString() == "P")  //계획_경영실적
            {
                if (this.FPS91_TY_S_AC_39633586.ActiveSheet.RowCount != 0)
                {
                    ...
                    if (CBH01_ESPLCMPY.GetValue().ToString() != "TG")
                    {
                        ...
                        {
                            if (this.FPS91_TY_S_AC_39633586.GetValue(i, "ESMCUST").ToString() != "")
                            {
            ...
            else if (this.CBO01_EPLCGB.GetValue().ToString() == "B") // 재무상태표
            {
                if (this.FPS91_TY_S_AC_39635587.ActiveSheet.RowCount != 0)
                {
                    ...
                    if (CBH01_ESPLCMPY.GetValue().ToString() != "TG")
                    {
                        ...
                        {
                            if (this.FPS91_TY_S_AC_39635587.GetValue(i, "ESMCUST").ToString() != "")
                            {
            ...
            else if (this.CBO01_EPLCGB.GetValue().ToString() == "R") // 자금수지 계획
            {
                ...
                {
                    string sCUST = this.FPS91_TY_S_AC_3BB34247.GetValue(0, "EPFSUBGN").ToString();
                    string sYYMM = this.FPS91_TY_S_AC_3BB34247.GetValue(0, "EPFYYMM").ToString();
                ...
                {
                    if (this.FPS91_TY_S_AC_3BB34247.GetValue(i, "EPFSUBGN").ToString() != "")
                    {
                ...
                //    if (Convert.ToDouble(sYYMM) <= 201311)
                //    {
                //        this.DbConnector.CommandClear();
                ...
                //// 등록
                //string sCHKYYMM = string.Empty;
                //this.DbConnector.CommandClear();
                //for (int i = 0; i < this.FPS91_TY_S_AC_3BB34247.ActiveSheet.RowCount; i++)
                //{
                //    sCHKYYMM = this.FPS91_TY_S_AC_3BB34247.GetValue(i, "EPFYYMM").ToString();   // 년월

                //    if (Convert.ToDouble(sCHKYYMM) <= 201311)
                //    {
            ...
            else if (this.CBO01_EPLCGB.GetValue().ToString() == "M") // 티와이스틸 매출자료
            {
                // 삭제
            ...
            else if (this.CBO01_EPLCGB.GetValue().ToString() == "C") // 차입금 세부
            {
                ...
                {
                    string sCUST = this.FPS91_TY_S_AC_3AH5T074.GetValue(0, "BORCUST").ToString();
                    string sYYMM = this.FPS91_TY_S_AC_3AH5T074.GetValue(0, "BORYYHD").ToString();
            ...
            else if (this.CBO01_EPLCGB.GetValue().ToString() == "G") // GLS 매출
            {
                // 삭제
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            if (this.txtFile.Text.Trim() != "")
            {
                ...
                else if (this.CBO01_EPLCGB.GetValue().ToString() == "G")
                {
                    ...
                    this.FPS91_TY_S_AC_3A159942.Visible = false;  // 티와이스틸 매출
                    this.FPS91_TY_S_AC_3AH5T074.Visible = false;  // 차입금 세부
                    this.FPS91_TY_S_AC_3AUA9134.Visible = true;  // GLS 매출
                }
                ...
                {
                    this.FPS91_TY_S_AC_3AUA9134.SetValue(ExcelDs); // GLS 매출
                }
        ...
        private void CBO01_EPLCGB_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.CBO01_EPLCGB.GetValue().ToString() == "P")
            {
                ...
                this.FPS91_TY_S_AC_3BB34247.Visible = false; // GLS 주요매출
            }
            else if (this.CBO01_EPLCGB.GetValue().ToString() == "B")
            {
                this.FPS91_TY_S_AC_39633586.Visible = false; // 손익자료
            ...
            else if (this.CBO01_EPLCGB.GetValue().ToString() == "R")
            {
                ...
                this.FPS91_TY_S_AC_3AH5T074.Visible = false; // 차입금 세부
                this.FPS91_TY_S_AC_3AUA9134.Visible = false; // GLS 주요매출
            ...
            else if (this.CBO01_EPLCGB.GetValue().ToString() == "G")
            {
                ...
                this.FPS91_TY_S_AC_3A159942.Visible = false; // 티와이스틸 주요매출
                this.FPS91_TY_S_AC_3AH5T074.Visible = false; // 차입금 세부
                this.FPS91_TY_S_AC_3AUA9134.Visible = true;  // GLS 주요매출
        ...
        private DataSet Convert_DataSet(DataSet ds)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                {
                    if (SetDefaultValue(ds.Tables[0].Rows[i][1].ToString().Trim()).Length == 6)
                    {
                        ...
                        if (this.CBO01_EPLCGB.GetValue().ToString() == "P")
                        {
                            ...
                            sTMUSAMT = "0"; // Get_Numeric(SetDefaultValue(ds.Tables[0].Rows[i][5].ToString().Trim()));
        ...
        private DataSet Convert_DataSet_FUND(DataSet ds)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                if (SetDefaultValue(ds.Tables[0].Rows[i][0].ToString().Trim()) != "")
                {
                    ...
                    sEAFSAMM = "0";// Get_Numeric(SetDefaultValue(ds.Tables[0].Rows[i][6].ToString().Trim()));      // 당월실적액
                    sEAFNEMM = "0";// Get_Numeric(SetDefaultValue(ds.Tables[0].Rows[i][7].ToString().Trim()));      // 익월예상액
        ...
        private DataSet Convert_DataSet_borr(DataSet ds)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                if (SetDefaultValue(ds.Tables[0].Rows[i][0].ToString().Trim()) != "")
                {
                    ...
                    {
                        sBORNOSQ = Get_Numeric(Convert.ToString(i + 1));                    // 차입금번호
                    }
                    else
                    {
