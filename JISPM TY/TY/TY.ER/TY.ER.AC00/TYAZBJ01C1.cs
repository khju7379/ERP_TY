...
namespace TY.ER.AC00
{
    ...
    ///  J2CDDP : 팀코드
    /// </summary>
    public partial class TYAZBJ01C1 : TYBase, IPopupHelper
    {
        ...
        private void TYAZBJ01C1_Load(object sender, System.EventArgs e)
        {
            fsBudGetTabGn = "";
            ...
            if (this._TComboHelper != null && this._TComboHelper.DummyValue != null)
            {
                ...
                {
                    this.fsDTMK = value[0];  //작성일자
                    this.fsCDDP = value[1];  //귀속부서
                    this.fsCDAC = value[2];  //계정과목
        ...
        public DataTable GetDataSource(params string[] parameters)
        {
            ...
            if (fsBudGetTabGn == "1")  //소모품비 예산
            {
                ...
                this.DbConnector.Attach("TY_P_AC_2AU2N917", this.fsDTMK.ToString().Substring(0, 4), this.fsCDDP.ToString(), this.fsCDAC.ToString(),
                                                            parameters[1].Substring(10, 3), parameters[1].Substring(13, 3));
            ...
            else if (fsBudGetTabGn == "2") //여비교통비 예산
            {
                ...
                this.DbConnector.Attach("TY_P_AC_2AU2B914", this.fsDTMK.ToString().Substring(0, 4), this.fsCDDP.ToString(), this.fsCDAC.ToString(),
                                                            parameters[1].Substring(10, 6), parameters[1].Substring(16,3));
            ...
            else if (fsBudGetTabGn == "3")  //기타세목 예산
            {
                ...
                this.DbConnector.CommandClear();
                this.DbConnector.Attach("TY_P_AC_2AU2P918", this.fsDTMK.ToString().Substring(0, 4), this.fsCDDP.ToString(), this.fsCDAC.ToString(),
                                                            parameters[1].Substring(10, 3));
            }
        ...
        public void Initialize_Helper(TCodeBox sender)
        {
            ...
            this.DTP01_B2DTMK.Initialize();
            this.CBH01_J2CDDP.Initialize();
            this.CBH01_J2CDAC.Initialize();
        }
        ...
        public void ShowPopupHelper()
        {
            ...
            {
                this.TYAZBJ01C1_Load(null, null);
        ...
        private void DTP01_B2DTMK_ValueChanged(object sender, EventArgs e)
        {
            ...
            this.CBH01_J2CDDP.DummyValue = this.DTP01_B2DTMK.GetString();
