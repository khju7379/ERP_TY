...
namespace TY.ER.AC00
{
    ...
    ///  GBPRYYMM : 처리년월
    /// </summary>
    public partial class TYACSE006B : TYBase
    {
        public TYACSE006B()
        {
            InitializeComponent();
        ...
        private void TYACSE006B_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_BATCH_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_AC_43J4Y821", this.DTP01_GBPRYYMM.GetValue(), Employer.EmpNo.ToString().Trim(), sOUTMSG.ToString());
