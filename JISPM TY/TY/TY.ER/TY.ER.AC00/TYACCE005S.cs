...
namespace TY.ER.AC00
{
    ...
    ///  GSTYYMM : 시작년월
    /// </summary>
    public partial class TYACCE005S : TYBase
    {
        ...
        private void TYACCE005S_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.FPS91_TY_S_AC_2523B961.SetValue(this.DbConnector.ExecuteDataTable());
        }
        #endregion
        ...
        private void BTN61_PRT_Click(object sender, EventArgs e)
        {
            ...
            SectionReport rpt = new TYACCE005R();
