...
namespace TY.ER.AC00
{
    ...
    ///  GBPRYYMM : 처리년월
    /// </summary>
    public partial class TYACNC010B : TYBase
    {
        public TYACNC010B()
        {
            InitializeComponent();
        ...
        private void TYACNC010B_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_BATCH_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_AC_29481783", this.DTP01_GBPRYYMM.GetValue(), "I", sOUTMSG.ToString() );
