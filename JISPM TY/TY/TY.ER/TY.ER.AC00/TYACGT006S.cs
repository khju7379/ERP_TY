...
namespace TY.ER.AC00
{
    ...
    /// 
    /// # 프로시저 정보 ####
    ///  TY_P_AC_25L1F571 : 매출처별 세금계산서 명세서 조회
    ///  TY_P_AC_25L1G572 : 매출처별 세금계산서 명세서 출력
    /// 
    ///  # 스프레드 정보 ####
    ///  TY_S_AC_25L1P575 : 매출처별 세금계산서 조회
    /// 
    ///  # 알림문자 정보 ####
    ...
    ///  GSTYYMM : 시작년월
    /// </summary>
    public partial class TYACGT006S : TYBase
    {
        ...
        private void TYACGT006S_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            string sFirstB4VLMI1 = this.CBO01_B4VLMI1.GetFirstValue().ToString();

            string sLastB4VLMI1 = this.CBO01_B4VLMI1.GetLastValue().ToString();
            ...
            if (dt.Rows.Count > 0)
            {
                this.FPS91_TY_S_AC_25L1P575.SetValue(dt);

                // 특정 ROW 색깔 입히기
                for (int i = 0; i < this.FPS91_TY_S_AC_25L1P575.ActiveSheet.RowCount; i++)
                {
                    if (this.FPS91_TY_S_AC_25L1P575.GetValue(i, "VNCODE").ToString() == "소계")
                    {
                        // 특정 ROW 색깔 입히기
                        this.FPS91_TY_S_AC_25L1P575.ActiveSheet.Rows[i].BackColor = Color.FromArgb(218, 239, 244);
                    }
                }
            }
            else
        ...
        private void BTN61_PRT_Click(object sender, EventArgs e)
        {
            ...
            SectionReport rpt = new TYACGT006R();
