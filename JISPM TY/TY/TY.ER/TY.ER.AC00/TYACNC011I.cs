...
namespace TY.ER.AC00
{
    ...
    ///  APCYNTB : T/B계정여부
    /// </summary>
    public partial class TYACNC011I : TYBase
    {
        ...
        public TYACNC011I(string APCCDAC)
        {
            InitializeComponent();
        ...
        private void TYACNC011I_Load(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                this.DbConnector.Attach("TY_P_AC_25EBF378", _APCCDAC);
        ...
        private void BTN61_SAV_Click(object sender, EventArgs e)
        {
            ...
            {
                this.DbConnector.Attach("TY_P_AC_25EBS389", this.ControlFactory, "01"); // 저장
            }
            else
            {
                this.DbConnector.Attach("TY_P_AC_25EBT392", this.ControlFactory, "01"); // 수정
            }
