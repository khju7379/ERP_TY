...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACTX011R3 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public TYACTX011R3(DataTable dt, DataTable dt2, string sYEAR, string sRPTGUBN, string sCONFGB)
        {
            this._dt = dt;
            this._dt2 = dt2;
        ...
        private void TYACTX011R3_ReportStart(object sender, EventArgs e)
        {
            ...
            if (dt != null)
            {
                if (dt.Rows.Count > 5)
                {
                    TYACTX011R4 subReport = new TYACTX011R4();
                    subReport.DataSource = dt;
                    TYACTX011R4.Report = subReport;
                }
            }
        }
