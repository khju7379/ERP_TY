...
namespace TY.ER.AC00
{
    ...
    ///  SEARCH : 찾아보기
    /// </summary>
    public partial class TYACTX022B : TYBase
    {
        ...
        private void TYACTX022B_Load(object sender, System.EventArgs e)
        {
        ...
        {
            string sExeFile = @"C:\ers\ers.exe";
            if (File.Exists(sExeFile))
            {
                System.Diagnostics.Process program = System.Diagnostics.Process.Start(@"C:\ers\ers.exe");
            }
            else
            {
