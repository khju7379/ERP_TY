...
namespace TY.ER.AC00
{
    ...
    /// 
    ///  # 스프레드 정보 ####
    ///  TY_S_AC_29HAZ136 : 받을어음결재관리 결재처리 조회
    /// 
    ///  # 알림문자 정보 ####
    ...
    ///  E7NOACB : 계좌번호
    /// </summary>
    public partial class TYACEI005I : TYBase
    {
        ...
        private string fsDTED = "";
        private string fsGubn = "";

        #region Description : 폼 로드 이벤트
        public TYACEI005I(DataSet ds, string sDTED, string sJpno, string sGubn)
        {
            InitializeComponent();
        ...
        private void TYACEI005I_Load(object sender, System.EventArgs e)
        {
            ...
            if (fsGubn == "A")
            {
                ...
                this.FPS91_TY_S_AC_29HAZ136.SetValue(fsds.Tables[0]);

                if (this.FPS91_TY_S_AC_29HAZ136.CurrentRowCount > 0)
                {
                    this.SpreadSumRowAdd(this.FPS91_TY_S_AC_29HAZ136, "E6NONR", "합  계", SumRowType.Sum, "E6AMNR");
                }

                for (int i = 0; i < this.FPS91_TY_S_AC_29HAZ136.CurrentRowCount - 1; i++)
                {
                    this.FPS91_TY_S_AC_29HAZ136.ActiveSheet.RowHeader.Cells[i, 0].Text = "N";
                }
                ...
                if (this.FPS91_TY_S_AC_29HAZ136.CurrentRowCount > 0)
                {
                    ...
                    for (int i = 0; i < this.FPS91_TY_S_AC_29HAZ136.CurrentRowCount - 1; i++)
                    {
                        ...
                        this.FPS91_TY_S_AC_29HAZ136.SetValue(row, "E6DTAP", this.DTP01_E6DTAP.GetValue());
                    }
                }
                else
                {
            ...
            else
            {
                ...
                this.DbConnector.Attach("TY_P_AC_5BPAA215", "20", this.TXT01_ARJUNNO.GetValue().ToString().Replace("-", ""), fsDTED);
                DataTable dt = this.DbConnector.ExecuteDataTable();
                this.FPS91_TY_S_AC_29HAZ136.SetValue(dt);
        ...
        private void BTN61_BTNJUNPYO_Click(object sender, EventArgs e)
        {
            ...
            {
                this.DbConnector.CommandClear();
                this.DbConnector.Attach("TY_P_AC_29H36143", this.DTP01_E6DTAP.GetString().ToString(), "20", this.CBH01_E6CDGL.GetValue().ToString(), this.CBH01_E7NOACB.GetValue().ToString());
                ...
                if (dj.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dj.Rows.Count; i++)
                    {
                        ...
                        this.DAT02_W2CDAC.SetValue(dj.Rows[i]["E7NOACI"].ToString());
                        ...
                        //관리항목 
                        this.DbConnector.CommandClear();
                        this.DbConnector.Attach("TY_P_AC_23N3M888", dj.Rows[i]["E7NOACI"].ToString(), "");
                        ...
                        //보통예금
                        if (dj.Rows[i]["E7NOACI"].ToString() == "11100302")
                        {
                            //은행
                            this.DAT02_W2VLMI1.SetValue(dj.Rows[i]["E6CDGL"].ToString());
                            //계좌
                            this.DAT02_W2VLMI2.SetValue(dj.Rows[i]["E7NOACB"].ToString());
                        ...
                        //당좌예금
                        if (dj.Rows[i]["E7NOACI"].ToString() == "11100301")
                        {
                            //은행
                            this.DAT02_W2VLMI1.SetValue(dj.Rows[i]["E6CDGL"].ToString());
                            //계좌
                        ...
                        this.DAT02_W2RKCU.SetValue(dj.Rows[i]["E6CDGLNM"].ToString());
                    ...
                    for (int i = 0; i < dj.Rows.Count; i++)
                    {
                        ...
                        this.DAT02_W2CDFD.SetValue("11120");
                        this.DAT02_W2AMFD.SetValue(dj.Rows[i]["E6AMNR"].ToString());
                        this.DAT02_W2RKAC.SetValue(sW2RKAC);
        ...
        private void BTN61_SAV_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                dataM.Add(new object[] {"20",ds.Tables[0].Rows[i]["E6DTAP"].ToString(), this.CBH01_E6CDGL.GetValue().ToString(), ds.Tables[0].Rows[i]["E6DTAP"].ToString(), ds.Tables[0].Rows[i]["E6NONR"].ToString()});
        ...
        private void BTN61_SAV_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            ds.Tables.Add(this.FPS91_TY_S_AC_29HAZ136.GetDataSourceInclude(TSpread.TActionType.New, "E6NONR", "E6DTED", "E6CDGL", "E6CDGLNM", "E6AMNR", "E6CDCL", "E6CDCLNM", "E6IDBG", "E6IDBGNM", "E6CDCM", "E6DTAP","E6DTBG"));
        ...
        {
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_AC_29H36143", sE7DTBG, "20", sE7CDGL, sE7NOACB);
            this.FPS91_TY_S_AC_29HAZ136.SetValue(this.DbConnector.ExecuteDataTable());
