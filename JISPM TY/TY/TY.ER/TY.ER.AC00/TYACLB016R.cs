...
namespace TY.ER.AC00
{
    ...
    /// </summary>
    public partial class TYACLB016R : GrapeCity.ActiveReports.SectionReport
    {
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            this.P2CDAC.Font = new Font("굴림", 9, FontStyle.Regular);
            this.P2SEQ.Font = new Font("굴림", 9, FontStyle.Regular);
            this.A1ABAC.Font = new Font("굴림", 9, FontStyle.Regular);
            this.P1RKAC.Font = new Font("굴림", 9, FontStyle.Regular);
            ...
            if (dt.Rows[_iCount - 1]["P2CDAC"].ToString() == "계 정 계" || dt.Rows[_iCount - 1]["P2CDAC"].ToString() == "부 서 계" ||
                dt.Rows[_iCount - 1]["P2CDAC"].ToString() == "총     계")
            {
                this.P2CDAC.Font = new Font("굴림", 9, FontStyle.Bold);
                this.P2SEQ.Font = new Font("굴림", 9, FontStyle.Bold);
                this.A1ABAC.Font = new Font("굴림", 9, FontStyle.Bold);
                this.P1RKAC.Font = new Font("굴림", 9, FontStyle.Bold);
            ...
            {
                if (dt.Rows[_iCount - 1]["P2CDAC"].ToString() == "부 서 계")
                {
            ...
            // 레코드가 13이면 레코드를 0으로 바꾸거나 0이 아니면 레코드카운트 + 1
        ...
        private void TYACLB016R_DataInitialize(object sender, EventArgs e)
        {
