...
namespace TY.ER.HR00
{
    ...
    ///  YYYYMM : 기준 년월
    /// </summary>
    public partial class TYHRYB001B : TYBase
    {
        ...
        private void TYHRYB001B_Load(object sender, System.EventArgs e)
        {
            // 처리 체크
        ...
        private void BTN61_BATCH_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    fsYYDATE  = this.DTP01_EDDATE.GetString().Substring(0,6);
                    fsYYSABUN = this.CBH01_YYSABUN.GetValue().ToString();

                    if (this.CBO01_GGUBUN.GetValue().ToString() == "A")
                    {
                        this.ShowMessage("TY_M_HR_59UFG942");
                    }
                    else
                    {
                        this.ShowMessage("TY_M_HR_5BPHM217");
                    }
                }
                else
                {
                    if (this.CBO01_GGUBUN.GetValue().ToString() == "A")
                    {
                        this.ShowMessage("TY_M_HR_59UFH944");
                    }
                    else
                    {
                        this.ShowMessage("TY_M_HR_5BPHN218");
                    }
                }
            }
            catch
        ...
        private void BTN61_BATCH_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            {
                this.ShowMessage("TY_M_HR_59UFG943");
            }
        }
        #endregion
