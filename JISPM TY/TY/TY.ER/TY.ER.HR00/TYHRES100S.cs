...
namespace TY.ER.HR00
{
    ...
    ///  EAYYMM : 기준년월
    /// </summary>
    public partial class TYHRES100S : TYBase
    {
        ...
        private void TYHRES100S_Load(object sender, System.EventArgs e)
        {
        ...
        private void UP_TreeView_ORG(string sEAYYMM )
        {
            ...
            this.DbConnector.Attach("TY_P_HR_28S5E603", "TH", sEAYYMM,  "TH", sEAYYMM);
        ...
        private void TRV01_ORG_MouseDoubleClick(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            this.FPS91_TY_S_HR_28S5M606.Initialize();
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_HR_47MD0089", fsEAYYMM, fsENTER_CD, sCODE);
        ...
        private void UP_RightSpreadMember(string sCODE)
        {
            ...
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_HR_47MD4090", this.DTP01_EMYYMM.GetValue(), fsENTER_CD, this.CBH01_EMORG_CD.GetValue());
