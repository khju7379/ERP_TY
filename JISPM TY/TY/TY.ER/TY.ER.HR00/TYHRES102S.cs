...
namespace TY.ER.HR00
{
    ...
    ///  ORG_CHART_NM : 조직도명
    /// </summary>
    public partial class TYHRES102S : TYBase
    {
        ...
        private void TYHRES102S_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_HR_28N1T512", "TH");
        ...
        private void BTN61_ORGADD_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_HR_28O3W545", ds.Tables[0]);
        ...
        private void TRV01_ORG_MouseDoubleClick(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_HR_47LDP060", this.TXT01_ENTER_CD.GetValue(), this.TXT01_ORG_CHART_NM.GetValue(), fsSDATE, sCODE);
        ...
        private void UP_RightSpreadDisplay()
        {
            this.FPS91_TY_S_HR_28N21518.Initialize();
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_HR_47MB3083", this.TXT01_ENTER_CD.GetValue(), this.TXT01_ORG_CHART_NM.GetValue(), fsSDATE, this.CBH01_PRIOR_ORG_CD.GetValue());
        ...
        private void UP_TreeView_ORG(string sENTER_CD, string sORG_CHART_NM, string sSDATE)
        {
            ...
            this.DbConnector.Attach("TY_P_HR_47LDJ059", sENTER_CD, sORG_CHART_NM, sSDATE, sENTER_CD, sORG_CHART_NM, sSDATE);
            DataTable dt = this.DbConnector.ExecuteDataTable();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                this.TRV01_ORG.SetValue(new object[] { "태영호라이즌", "0", this._dataSource });
            }
        }
        #endregion
    }
