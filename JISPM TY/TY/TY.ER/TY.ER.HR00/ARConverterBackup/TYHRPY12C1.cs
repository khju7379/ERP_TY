    ...
    public partial class TYHRPY12C1 : TYBase
    {
        ...
        private void BTN61_PRT_Click(object sender, EventArgs e)
        {
            ...
            if (this.CBO01_EDGUBN.GetValue().ToString() == "1")
            {
                ...
                //ActiveReport rpt = new TYHRPY12R2(dt2);
                ActiveReport rpt = new TYHRPY12R5(dt2);
            ...
            else
            {
                ...
                {
                    ActiveReport rpt = new TYHRPY12R4(this.TXT01_PAYYYMM.GetValue().ToString().Replace("-", ""), sGUBUNNM);
                ...
                {
                    ActiveReport rpt = new TYHRPY12R1(this.TXT01_PAYYYMM.GetValue().ToString().Replace("-", ""), sGUBUNNM);
                    (new TYERGB001P(rpt, UP_DtChange(dt, "1"))).ShowDialog();
                }
                else
                {
                    ActiveReport rpt = new TYHRPY12R3(this.TXT01_PAYYYMM.GetValue().ToString().Replace("-", ""), sGUBUNNM);
