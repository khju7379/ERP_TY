...
namespace TY.ER.HR00
{
    ...
    ///  YYYYMM : 기준 년월
    /// </summary>
    public partial class TYHRKB024S : TYBase
    {
        ...
        private void TYHRKB024S_Load(object sender, System.EventArgs e)
        {
            ToolStripMenuItem reateAdd = new ToolStripMenuItem("중도정산등록");
            reateAdd.Click += new EventHandler(Add_ToolStripMenuItem_Click);            

            this.FPS91_TY_S_HR_BBUFN831.CurrentContextMenu.Items.AddRange(
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.FPS91_TY_S_HR_BBUFN831.SetValue(dt);
        }
        #endregion
        ...
        private void BTN61_REM_Click(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    this.DbConnector.Attach("TY_P_HR_BC1ED850", Get_Numeric(ds.Tables[0].Rows[i]["PSSABUN"].ToString()),
                                                                Get_Numeric(ds.Tables[0].Rows[i]["PSYDATE"].ToString())
                                                                );

                    this.DbConnector.Attach("TY_P_HR_BC1EE851", Get_Numeric(ds.Tables[0].Rows[i]["PSSABUN"].ToString()),
                                                                Get_Numeric(ds.Tables[0].Rows[i]["PSYDATE"].ToString())
                                                                );
        ...
        private void BTN61_REM_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            ds.Tables.Add(this.FPS91_TY_S_HR_BBUFN831.GetDataSourceInclude(TSpread.TActionType.Remove, "PSSABUN", "PSYDATE"));
        ...
        private void FPS91_TY_S_HR_BBUFN831_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            if (this.FPS91_TY_S_HR_BBUFN831.GetValue("KBJKCD").ToString() != "01")
            {
                // 파라미터값 보내기
                if ((new TYHRKB017I(this.FPS91_TY_S_HR_BBUFN831.GetValue("PSSABUN").ToString(), this.FPS91_TY_S_HR_BBUFN831.GetValue("PSYDATE").ToString(),
                                    this.FPS91_TY_S_HR_BBUFN831.GetValue("PSGUBN").ToString(), this.FPS91_TY_S_HR_BBUFN831.GetValue("PSWKSDATE").ToString(),
                                    this.FPS91_TY_S_HR_BBUFN831.GetValue("PSWKEDATE").ToString(), this.FPS91_TY_S_HR_BBUFN831.GetValue("PSJPNO").ToString(),
                                    this.FPS91_TY_S_HR_BBUFN831.GetValue("PSTYPE").ToString()
                                    )).ShowDialog() == System.Windows.Forms.DialogResult.OK)
                    this.BTN61_INQ_Click(null, null);
            }
            else
            {
                if (Convert.ToInt16(this.FPS91_TY_S_HR_BBUFN831.GetValue("KBJJCD").ToString()) <= 80)
                {
                    // 파라미터값 보내기
                    if ((new TYHRKB024I(this.FPS91_TY_S_HR_BBUFN831.GetValue("PSSABUN").ToString(), this.FPS91_TY_S_HR_BBUFN831.GetValue("PSYDATE").ToString(),
                                        this.FPS91_TY_S_HR_BBUFN831.GetValue("PSGUBN").ToString(), this.FPS91_TY_S_HR_BBUFN831.GetValue("PSWKSDATE").ToString(),
                                        this.FPS91_TY_S_HR_BBUFN831.GetValue("PSWKEDATE").ToString(), this.FPS91_TY_S_HR_BBUFN831.GetValue("PSJPNO").ToString(),
                                        this.FPS91_TY_S_HR_BBUFN831.GetValue("PSTYPE").ToString()
                                        )).ShowDialog() == System.Windows.Forms.DialogResult.OK)
        ...
        private void Add_ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (this.FPS91_TY_S_HR_BBUFN831.GetValue("PSGUBN").ToString() != "1")
            {
            ...
            (
            "TY_P_HR_5B9DS130",
            this.FPS91_TY_S_HR_BBUFN831.GetValue("PSSABUN").ToString(),
            this.FPS91_TY_S_HR_BBUFN831.GetValue("PSYDATE").ToString(),
            this.FPS91_TY_S_HR_BBUFN831.GetValue("PSGUBN").ToString()
            );
