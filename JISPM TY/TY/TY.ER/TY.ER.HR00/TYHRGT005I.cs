...
namespace TY.ER.HR00
{
    ...
    ///  GIYUNJGST : 연장시간STD
    /// </summary>
    public partial class TYHRGT005I : TYBase
    {
        ...
        private void TYHRGT005I_Load(object sender, System.EventArgs e)
        {
            ...
            this.DTP01_EDATE.SetValue(DateTime.Now.ToString("yyyy-MM-dd"));
                ...
                this.UP_ButtonCheck(true, false, false);
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.FPS91_TY_S_HR_4BQJV571.Initialize();
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_HR_4BQJP565", this.DTP01_SDATE.GetString(), this.DTP01_EDATE.GetString(), this.CBH01_KBSABUN.GetValue(), this.CBO01_KBGUNMU.GetValue());
            this.FPS91_TY_S_HR_4BQJV571.SetValue(this.DbConnector.ExecuteDataTable());
        }
        #endregion
        ...
        private void BTN61_NEW_Click(object sender, EventArgs e)
        {
            ...
            this.UP_FieldLock(false);

            this.SetFocus(this.DTP02_GIDATE);

            this.UP_ButtonCheck(true, true, false);
        }
        #endregion
        ...
        private void BTN61_SAV_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            //출근인정시간 있으면 출근시간도 있어야 한다.
            if (this.MTB02_GIINCHLTM.GetValue().ToString().Replace(":", "").Trim() != "" && Convert.ToInt32(this.MTB02_GIINCHLTM.GetValue().ToString().Replace(":", "").Trim()) > 0)
            {
                if (this.MTB02_GICHLTIME.GetValue().ToString().Replace(":", "").Trim() == "" || Convert.ToInt32(this.MTB02_GICHLTIME.GetValue().ToString().Replace(":", "").Trim()) <= 0)
                {
                    this.SetFocus(this.MTB02_GICHLTIME);
                    this.ShowCustomMessage("출근시간을 입력하세요!", "오류", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                    e.Successed = false;
                    return;
                }
            }
            ...
            //퇴근인정시간 있으면 퇴근시간도 있어야 한다.
            if (this.MTB02_GIINENDTM.GetValue().ToString().Replace(":", "").Trim() != "" && Convert.ToInt32(this.MTB02_GIINENDTM.GetValue().ToString().Replace(":", "").Trim()) > 0)
            {
                if (this.MTB02_GIENDTIME.GetValue().ToString().Replace(":", "").Trim() == "" || Convert.ToInt32(this.MTB02_GIENDTIME.GetValue().ToString().Replace(":", "").Trim()) <= 0)
                {
                    this.SetFocus(this.MTB02_GIENDTIME);
                    this.ShowCustomMessage("퇴근시간을 입력하세요!", "오류", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                    e.Successed = false;
                    return;
                }
            }
            ...
            //야간출인시간 있으면 야간출근시간도 있어야 한다.
            if (this.MTB02_GIYAINCHL.GetValue().ToString().Replace(":", "").Trim() != "" && Convert.ToInt32(this.MTB02_GIYAINCHL.GetValue().ToString().Replace(":", "").Trim()) > 0)
            {
                if (this.MTB02_GIYACHLTM.GetValue().ToString().Replace(":", "").Trim() == "" || Convert.ToInt32(this.MTB02_GIYACHLTM.GetValue().ToString().Replace(":", "").Trim()) <= 0)
                {
                    this.SetFocus(this.MTB02_GIYACHLTM);
                    this.ShowCustomMessage("야근출근시간을 입력하세요!", "오류", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                    e.Successed = false;
                    return;
                }
            }
            ...
            //야간퇴근인정시간 있으면 야간퇴근시간도 있어야 한다.
            if (this.MTB02_GIYAINEND.GetValue().ToString().Replace(":", "").Trim() != "" && Convert.ToInt32(this.MTB02_GIYAINEND.GetValue().ToString().Replace(":", "").Trim()) > 0)
            {
                if (this.MTB02_GIYAENDTM.GetValue().ToString().Replace(":", "").Trim() == "" || Convert.ToInt32(this.MTB02_GIYAENDTM.GetValue().ToString().Replace(":", "").Trim()) <= 0)
                {
                    this.SetFocus(this.MTB02_GIYAENDTM);
                    this.ShowCustomMessage("야근퇴근시간을 입력하세요!", "오류", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                    e.Successed = false;
                    return;
                }
            }
            ...
            this.TXT02_GIINTIME.SetValue(String.Format("{0:#0.00}", Convert.ToDecimal(Get_Numeric(this.TXT02_GIINTIME.GetValue().ToString()))));
        ...
        private void FPS91_TY_S_HR_4BQJV571_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            this.UP_Run(this.FPS91_TY_S_HR_4BQJV571.GetValue("GIDATE").ToString(), this.FPS91_TY_S_HR_4BQJV571.GetValue("GISABUN").ToString());

            this.UP_FieldLock(true);

            this.SetStartingFocus(this.MTB02_GICHLTIME);

            this.UP_ButtonCheck(true, true, true);
        }
        #endregion
        ...
        private void UP_FieldClear()
        {
            ...
            this.TXT02_GIGJTIME.SetValue("0.0");

            this.CBO02_GIHUILGN.SetValue("N");
            this.CBO02_GICARDGB.SetValue("N");
        ...
        private void UP_ButtonCheck(bool bvalueNew, bool bvalueSav, bool bvalueRem)
        {
            this.BTN61_NEW.Visible = bvalueNew;
        ...
        {
            //조출(1.5), 심야(0.5), 연장(1.5), 철야(2), 특근(2.5) 심야특근(3)
            ...
            TXT02_GIINTIME.SetValue( string.Format("{0:#0.00}", dGIINTIME));
        }
        #endregion
