...
namespace TY.ER.HR00
{
    ...
    ///  SDATE : 시작일자
    /// </summary>
    public partial class TYHRES101S : TYBase
    {
        ...
        private void TYHRES101S_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_HR_28S9Q562","TH", this.DTP01_SDATE.GetValue(), this.TXT01_ORG_CD.GetValue() );
        ...
        {
            this.FPS91_TY_S_HR_28S9V568.SetValue(e.RowIndex, "ENTER_CD", "TH");
        }
        #endregion
    }
}
