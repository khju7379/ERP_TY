...
namespace TY.ER.US00
{
    ...
    /// 
    ///  # 스프레드 정보 ####
    ///  TY_S_US_94MH7428 : 전자세금계산서 발행 관리 조회
    /// 
    ///  # 알림문자 정보 ####
    ...
    public partial class TYUSME019I : TYBase
    {
        ...
        private string fsSUP_COMID = "tycculsilo";
        ...
        private object _CBO01_BILLMAECH_Value;
        ...
        private void TYUSME019I_Load(object sender, System.EventArgs e)
        {
            #region  Description : 전자세금계산용 DATA 선언
            ...
            (this.FPS91_TY_S_US_94MH7428.Sheets[0].Columns[18].Editor as TButtonCellType).Picture = global::TY.Service.Library.Properties.Resources.magnifier;
            (this.FPS91_TY_S_US_94MH7428.Sheets[0].Columns[19].Editor as TButtonCellType).Picture = global::TY.Service.Library.Properties.Resources.printer;

            this.SetSpreadFixedWidthColumn(this.FPS91_TY_S_US_94MH7428, "MCLOG");
            this.SetSpreadFixedWidthColumn(this.FPS91_TY_S_US_94MH7428, "MCPRT");
            ...
            this.FPS91_TY_S_US_94MH7428.CurrentContextMenu.Items.AddRange(
        ...
        {
            this.UP_DataBinding(CBO01_BILLMAECH.GetValue().ToString(), this.DTP01_SDATE.GetString().ToString(), this.DTP01_EDATE.GetString().ToString(),
                                this.CBH01_IHHANGCHA.GetValue().ToString(), this.CBH02_IHHANGCHA.GetValue().ToString(),
                                CBH01_IHHWAJU.GetValue().ToString(), CBH01_CHGOKJONG.GetValue().ToString());
        }
        #endregion

        #region  Description : UP_DataBinding 이벤트
        private void UP_DataBinding(string sBILLMAECH, string sSDATE, string sEDATE, string sSHANGACHA, string sEHANGACHA, string sMCHWAJU, string sSGOKJONG)
        {
            ...
            //    this.DbConnector.Attach("TY_P_UT_76LBJ923", sSDATE,
            //                                                sMCHWAJU,
            //                                                "",
            //                                                "",
            //                                                "",
            ...
            FPS91_TY_S_US_94MH7428.Initialize();
            ...
            {
                case "12": //시설사용료
                    sProCedureId = "TY_P_US_94MH1430";
                    break;
                case "13": //하역료
                    sProCedureId = "TY_P_US_94QGT477";
                    break;
                case "14": //보관료
                    sProCedureId = "TY_P_US_94UG0495";
                    break;
                case "15": //조출료
                    sProCedureId = "TY_P_US_95DEB538";
                    break;
                case "21": //이송료
                    sProCedureId = "TY_P_US_95EFC552";
                    break;
                case "17": //소급시설사용료
                    sProCedureId = "TY_P_US_95EBD547";
                    break;
                case "18": //소급하역료
                    sProCedureId = "TY_P_US_95FE8558";
                    break;
                case "19": //난작업비
                    sProCedureId = "TY_P_US_95GAH566";
                    break;
                case "20": //별첨화주
                    sProCedureId = "TY_P_US_95K9H583";
                    break;
            }

            if (sBILLMAECH != "20")
            {
                this.DbConnector.Attach(sProCedureId, sSDATE, sEDATE, sSHANGACHA, sEHANGACHA, sSGOKJONG, sMCHWAJU);
            }
            else
            {
                this.DbConnector.Attach(sProCedureId, sSDATE, sEDATE, sSHANGACHA, sEHANGACHA, sSGOKJONG, sMCHWAJU, sSDATE, sEDATE, sSHANGACHA, sEHANGACHA, sSGOKJONG, sMCHWAJU);
            }

            FPS91_TY_S_US_94MH7428.SetValue(UP_Get_SmartBillStatus(this.DbConnector.ExecuteDataTable()));

            if (FPS91_TY_S_US_94MH7428.CurrentRowCount > 0)
            {
                for (int i = 0; i < FPS91_TY_S_US_94MH7428.CurrentRowCount; i++)
                {
                    if (this.FPS91_TY_S_US_94MH7428_Sheet1.Cells[i, 17].Text == "N")
                    {
                        this.FPS91_TY_S_US_94MH7428_Sheet1.Cells[i, 19].CellType = new FarPoint.Win.Spread.CellType.TextCellType();
                    }

                    this.FPS91_TY_S_US_94MH7428_Sheet1.Cells[i, 5].ForeColor = UP_StatusTextColor(this.FPS91_TY_S_US_94MH7428.GetValue(i, "MCBILLSTATUS").ToString());
                    this.FPS91_TY_S_US_94MH7428_Sheet1.Cells[i, 6].ForeColor = UP_StatusTextColor(this.FPS91_TY_S_US_94MH7428.GetValue(i, "MCBILLSTATUS").ToString());
                }
            }
        ...
        private DataTable UP_Get_SmartBillStatus(DataTable dt)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    rw["MCHANGCHA"] = dt.Rows[i]["MCHANGCHA"].ToString();
                    rw["MCGOKJONG"] = dt.Rows[i]["MCGOKJONG"].ToString();
                    rw["MCGOKJONGNM"] = dt.Rows[i]["MCGOKJONGNM"].ToString();
        ...
        private void BTN61_BILL_SEND_Click(object sender, EventArgs e)
        {
            ...
            this._CBO01_BILLMAECH_Value = this.CBO01_BILLMAECH.GetValue();
            this._DTP01_SDATE_Value = this.DTP01_SDATE.GetString().ToString();
            this._CBH01_MCHWAJU_Value = this.CBH01_IHHWAJU.GetValue().ToString();
        ...
        private void BTN61_BILL_SEND_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            ds.Tables.Add(this.FPS91_TY_S_US_94MH7428.GetDataSourceInclude(TSpread.TActionType.Select, "MCGUBN", "MCDATE", "MCHANGCHA", "MCGOKJONG", "MCHWAJU", "MCBILLMAIL", "MCBILLSTATUS", "MCJPNO", "MCDANGAMT", "MCVATAMT", "MCTOTALAMT", "MCTAXSTATUS", "MCCONVERSATION_ID", "MCBIGO"));
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    this.DbConnector.CommandClear();
                    //this.DbConnector.Attach("TY_P_UT_93RAY189", ds.Tables[0].Rows[i]["MCJPNO"].ToString().Substring(0,17), ds.Tables[0].Rows[i]["MCCONVERSATION_ID"].ToString());
                    this.DbConnector.Attach("TY_P_UT_93RAY189", ds.Tables[0].Rows[i]["MCJPNO"].ToString().Substring(0, 17));
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (ds.Tables[0].Rows[i]["MCGUBN"].ToString() == "12") //시설사용료
                    {
                        UP_ProCess_FacilSales(ds.Tables[0], i, fsBATCH_ID);
                    }
                    else if (ds.Tables[0].Rows[i]["MCGUBN"].ToString() == "13") //하역료
                    {
                        UP_ProCess_LoadSales(ds.Tables[0], i, fsBATCH_ID);
                    }
                    else if (ds.Tables[0].Rows[i]["MCGUBN"].ToString() == "14") //보관료
                    {
                        UP_ProCess_StorageSales(ds.Tables[0], i, fsBATCH_ID);
                    }
                    else if (ds.Tables[0].Rows[i]["MCGUBN"].ToString() == "15") //조출료
                    {
                        UP_ProCess_DespatchSales(ds.Tables[0], i, fsBATCH_ID);
                    }
                    else if (ds.Tables[0].Rows[i]["MCGUBN"].ToString() == "21") //이송료
                    {
                        UP_ProCess_TransSales(ds.Tables[0], i, fsBATCH_ID);
                    }
                    else if (ds.Tables[0].Rows[i]["MCGUBN"].ToString() == "17") //소급시설사용료
                    {
                        UP_ProCess_RetroFacilSales(ds.Tables[0], i, fsBATCH_ID);
                    }
                    else if (ds.Tables[0].Rows[i]["MCGUBN"].ToString() == "18") //소급하역료
                    {
                        UP_ProCess_RetroLoadSales(ds.Tables[0], i, fsBATCH_ID);
                    }
                    else if (ds.Tables[0].Rows[i]["MCGUBN"].ToString() == "19") //난작업비
                    {
                        UP_ProCess_HardWorkSales(ds.Tables[0], i, fsBATCH_ID);
                    }
                    else if (ds.Tables[0].Rows[i]["MCGUBN"].ToString() == "20") //별첨화주
                    {
                        UP_ProCess_AnnexedSales(ds.Tables[0], i, fsBATCH_ID);
                    }
                }
        ...
        private void BTN61_BILL_REM_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            ds.Tables.Add(this.FPS91_TY_S_US_94MH7428.GetDataSourceInclude(TSpread.TActionType.Select, "MCGUBN", "MCDATE", "MCHWAJU", "MCBILLMAIL", "MCBILLSTATUS", "MCJPNO", "MCDANGAMT", "MCVATAMT", "MCTOTALAMT", "MCTAXSTATUS", "MCCONVERSATION_ID", "MCBIGO"));
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt.Rows.Count; j++)
                        {
                            ...
                            //국세청 전송상태
                            string sTaxSts = dt.Rows[j]["TAXSTATUS"].ToString();
        ...
        #region  Description : 시설사용료 매출 발송
        private void UP_ProCess_FacilSales(DataTable dt, int i, string sBATCH_ID)
        {
            string sCONVERSATION_ID = string.Empty;

            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_US_94N8T439", dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHANGCHA"].ToString(), dt.Rows[i]["MCGOKJONG"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString());
            ...
            if (dsms.Rows.Count > 0)
            {
                ...
                DAT01_SUP_AMOUNT.SetValue(dsms.Rows[0]["AMT"].ToString());
                DAT01_TAX_AMOUNT.SetValue(dsms.Rows[0]["VAT"].ToString());
                DAT01_TOTAL_AMOUNT.SetValue(dsms.Rows[0]["TOTAMT"].ToString());
                ...
                DAT01_XDHWAJU.SetValue(dsms.Rows[0]["HYHWAJU"].ToString());
                DAT01_XDMHGUBN.SetValue(dt.Rows[i]["MCGUBN"].ToString());
                DAT01_XDMJPNO.SetValue(dsms.Rows[0]["HYJPNO"].ToString());
                ...
                DAT02_ITEM_NAME.SetValue(dsms.Rows[0]["VSDESC1"].ToString());
                ...
                DAT02_SUP_AMOUNT.SetValue(dsms.Rows[0]["AMT"].ToString());
                DAT02_TAX_AMOUNT.SetValue(dsms.Rows[0]["VAT"].ToString());
                ...
                this.DAT04_INVOICE_NUM.SetValue(dsms.Rows[0]["HYJPNO"].ToString());

                UP_DataCollections_Add("Inv");
                #endregion

                //거래명세서 첨부
                UP_Set_InvoiceE_AttachFile(dt.Rows[i]["MCGUBN"].ToString(), dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHANGCHA"].ToString(), dt.Rows[i]["MCGOKJONG"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString());
            }
        }
        #endregion  
        ...
        private void UP_ProCess_LoadSales(DataTable dt, int i, string sBATCH_ID)
        {
            ...
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_US_94QF4468", dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHANGCHA"].ToString(), dt.Rows[i]["MCGOKJONG"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString());
            DataTable dsms = this.DbConnector.ExecuteDataTable();
            if (dsms.Rows.Count > 0)
            {
                #region  Description : XXSB_DTI_MAIN 저장
        ...
        private void UP_ProCess_StorageSales(DataTable dt, int i, string sBATCH_ID)
        {
            ...
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_US_94UGH496", dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHANGCHA"].ToString(), dt.Rows[i]["MCGOKJONG"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString());
            ...
            if (dsms.Rows.Count > 0)
            {
                ...
                //라인 1
                //보관료
                if (Convert.ToDouble(dsms.Rows[0]["AMT"].ToString()) > 0)
                {
                    iLineNum += 1;
        ...
        #region  Description : 조출료 매출 발송
        private void UP_ProCess_DespatchSales(DataTable dt, int i, string sBATCH_ID)
        {
            string sCONVERSATION_ID = string.Empty;
            int iLineNum = 0;

            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_US_95DEJ539", dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHANGCHA"].ToString(), dt.Rows[i]["MCGOKJONG"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString());
        ...
        #region  Description : 이송료 매출 발송
        private void UP_ProCess_TransSales(DataTable dt, int i, string sBATCH_ID)
        {
            string sCONVERSATION_ID = string.Empty;

            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_US_95EFH553", dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHANGCHA"].ToString(), dt.Rows[i]["MCGOKJONG"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString());
            DataTable dsms = this.DbConnector.ExecuteDataTable();
            if (dsms.Rows.Count > 0)
            {
                #region  Description : XXSB_DTI_MAIN 저장
        ...
        #region  Description : 소급시설사용료 매출 발송
        private void UP_ProCess_RetroFacilSales(DataTable dt, int i, string sBATCH_ID)
        {
            string sCONVERSATION_ID = string.Empty;

            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_US_95EBH548", dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString(), "12");
            DataTable dsms = this.DbConnector.ExecuteDataTable();
            if (dsms.Rows.Count > 0)
            {
                #region  Description : XXSB_DTI_MAIN 저장
        ...
        #region  Description : 소급하역료 매출 발송
        private void UP_ProCess_RetroLoadSales(DataTable dt, int i, string sBATCH_ID)
        {

            string sCONVERSATION_ID = string.Empty;

            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_US_95EBH548", dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString(), "13");
            DataTable dsms = this.DbConnector.ExecuteDataTable();
            if (dsms.Rows.Count > 0)
            {
                #region  Description : XXSB_DTI_MAIN 저장
        ...
        #region  Description : 난작업비 매출 발송
        private void UP_ProCess_HardWorkSales(DataTable dt, int i, string sBATCH_ID)
        {

            string sCONVERSATION_ID = string.Empty;

            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_US_95GAM567", dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHANGCHA"].ToString(), dt.Rows[i]["MCGOKJONG"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString());
            DataTable dsms = this.DbConnector.ExecuteDataTable();
            if (dsms.Rows.Count > 0)
            {
                #region  Description : XXSB_DTI_MAIN 저장
        ...
        #region  Description : 별첨화주 매출 발송
        private void UP_ProCess_AnnexedSales(DataTable dt, int i, string sBATCH_ID)
        {
            string sCONVERSATION_ID = string.Empty;
            int iLineNum = 0;
            ...
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_US_95KAX584", dt.Rows[i]["MCDATE"].ToString(), dt.Rows[i]["MCHWAJU"].ToString(), dt.Rows[i]["MCJPNO"].ToString());
            ...
            if (dsms.Rows.Count > 0)
            {
                ...
                if (Convert.ToDouble(dsms.Rows[0]["AMT"].ToString()) > 0)
                {
                    ...
                    DAT02_DTI_LINE_NUM.SetValue(iLineNum.ToString());
                    DAT02_ITEM_CODE.SetValue("");
                    DAT02_ITEM_NAME.SetValue(dsms.Rows[i]["VSDESC1"].ToString());
                    DAT02_ITEM_SIZE.SetValue("");
                    DAT02_ITEM_MD.SetValue(dt.Rows[i]["MCDATE"].ToString());
                    DAT02_UNIT_PRICE.SetValue("0");
                    DAT02_ITEM_QTY.SetValue("0");
        ...
        private void UP_Set_InvoiceE_AttachFile(string sMCGUBN, string sMCDATE, string sMCHANGCHA, string sMCGOKJONG, string sMCHWAJU, string sMCJPNO)
        {
            //거래명세서 생성            
            this.DbConnector.CommandClear();
            ...
            {
                case "12": //시설사용료
                    this.DbConnector.Attach("TY_P_US_941DJ210", sMCDATE, sMCHANGCHA, sMCHANGCHA, sMCGOKJONG, sMCHWAJU, sMCJPNO);
                    break;
                case "13": //하역료
                    this.DbConnector.Attach("TY_P_US_94QF8467", sMCDATE, sMCHANGCHA, sMCGOKJONG, sMCHWAJU, sMCJPNO);
                    break;
                case "14": //보관료
                    this.DbConnector.Attach("TY_P_US_942HA222", sMCDATE, sMCHANGCHA, sMCHANGCHA, sMCGOKJONG, sMCHWAJU, sMCJPNO);
                    break;
                case "15": //조출료
                    this.DbConnector.Attach("TY_P_US_941HB216", sMCDATE, sMCHANGCHA, sMCHANGCHA, sMCGOKJONG, sMCHWAJU, sMCJPNO);
                    break;
                case "21": //이송료
                    this.DbConnector.Attach("TY_P_US_942E9218", sMCDATE, sMCHANGCHA, sMCHANGCHA, sMCGOKJONG, sMCHWAJU, sMCJPNO);
                    break;
                case "17": //소급시설사용료
                    this.DbConnector.Attach("TY_P_US_964GX711", sMCDATE, sMCGOKJONG, sMCHWAJU, sMCJPNO);
                    break;
                case "18": //소급하역료
                    this.DbConnector.Attach("TY_P_US_964GR710", sMCDATE, sMCGOKJONG, sMCHWAJU, sMCJPNO);
                    break;
                case "19": //난작업비
                    this.DbConnector.Attach("TY_P_US_942FM221", sMCDATE, sMCHANGCHA, sMCHANGCHA, sMCGOKJONG, sMCHWAJU, sMCJPNO);
                    break;
                case "20": //별첨화주
                    //this.DbConnector.Attach("TY_P_US_942FM221", sMCDATE, sMCHANGCHA, sMCHANGCHA, sMCGOKJONG, sMCHWAJU, sMCJPNO);
                    break;
            ...
            if (sMCGUBN != "20")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        //보관료 
                        DataTable redt = QueryDataSetReport(dt, sMCDATE);

                        UP_Invoice_PdfFileDown(rpt, redt, sMCGUBN, DAT01_CONVERSATION_ID.GetValue().ToString() + ".pdf");
                        rpt.Dispose();
                    }
            ...
            else
            {
                ...
                SectionReport rpt2 = new SectionReport();
                ...
                // 별첨화주 - 하역료 거래명세서
                this.DbConnector.CommandClear();
                this.DbConnector.Attach("TY_P_US_95LFF597", sMCDATE,
                                                    sMCJPNO // 전표번호
                                                    );
                ...
                // 별첨화주 - 보관료 거래명세서
                this.DbConnector.CommandClear();
                this.DbConnector.Attach("TY_P_US_95LFG599", sMCDATE,
                                                    sMCJPNO // 전표번호
                                                    );
                ...
                {
                    ret_MCBK = QueryDataSetReport(dt_MCBK, sMCDATE);
                }
                ...
                SectionReport rpt = new TYUSME017R7();
                ...
                UP_Invoice_PdfFileDown(rpt, dt_MCHY, sMCGUBN, DAT01_CONVERSATION_ID.GetValue().ToString() + ".pdf");
                rpt.Dispose();
            }
        ...
        private void UP_Invoice_PdfFileDown(GrapeCity.ActiveReports.SectionReport rpt, DataTable dt, string sMCGUBN, string sFileName)
        {
        ...
        private DataTable UP_SetDataTable()
        {
            ...
            dt.Columns.Add("MCHANGCHA", typeof(System.String));
            dt.Columns.Add("MCGOKJONG", typeof(System.String));
            dt.Columns.Add("MCGOKJONGNM", typeof(System.String));
        ...
        private void reateMail_ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            string sBILLSTATUS = this.FPS91_TY_S_US_94MH7428.GetValue("MCBILLSTATUS").ToString();
            string sCONVERSATION_ID = this.FPS91_TY_S_US_94MH7428.GetValue("MCCONVERSATION_ID").ToString();
            string sMail = this.FPS91_TY_S_US_94MH7428.GetValue("MCBILLMAIL").ToString();
        ...
        private void FPS91_TY_S_US_94MH7428_ButtonClicked(object sender, FarPoint.Win.Spread.EditorNotifyEventArgs e)
        {
            if (e.Column == 18)
            {
                if ((new TYUTME24C2(this.FPS91_TY_S_US_94MH7428.GetValue("MCDATE").ToString(), this.FPS91_TY_S_US_94MH7428.GetValue("MCHWAJU").ToString(), this.FPS91_TY_S_US_94MH7428.GetValue("MCJPNO").ToString(), this.FPS91_TY_S_US_94MH7428.GetValue("MCCONVERSATION_ID").ToString()
                            )).ShowDialog() == System.Windows.Forms.DialogResult.OK)
                    this.BTN61_INQ_Click(null, null);
            }
            else if (e.Column == 19)
            {
                if (this.OpenModalPopup(new TYUTME24C3(this.FPS91_TY_S_US_94MH7428.GetValue("MCCONVERSATION_ID").ToString())) == System.Windows.Forms.DialogResult.OK)
                    this.BTN61_INQ_Click(null, null);
            }
        }
        #endregion
        ...
        private DataTable QueryDataSetReport(DataTable dt, string sMCDATE)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                {
                    if (int.Parse(Get_Date(sMCDATE).Trim()) >= 20200120)
                    {
                        this.DbConnector.CommandClear();
                        this.DbConnector.Attach("TY_P_US_94395224", Get_Date(sMCDATE).Trim().Substring(0, 6),
