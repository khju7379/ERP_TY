...
namespace TY.ER.US00
{
    ...
    /// 
    /// </summary>
    public partial class TYUSME038S : TYBase
    {
        ...
        private void TYUSME038S_Load(object sender, System.EventArgs e)
        {
            this.FPS91_TY_S_US_963F6696.Initialize();
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.FPS91_TY_S_US_963F6696.SetValue(dt);

            for (int i = 0; i < this.FPS91_TY_S_US_963F6696.ActiveSheet.RowCount; i++)
            {
                if (this.FPS91_TY_S_US_963F6696.GetValue(i, "TMDATE").ToString() == "소 계")
                {
                    // 특정 ROW 글자 크기 변경
                    this.FPS91_TY_S_US_963F6696.ActiveSheet.Rows[i].Font = new Font("굴림", 9, FontStyle.Bold);
                    this.FPS91_TY_S_US_963F6696.ActiveSheet.Rows[i].BackColor = Color.FromArgb(218, 239, 194);
                }

                if (this.FPS91_TY_S_US_963F6696.GetValue(i, "TMDATE").ToString() == "총 계")
                {
                    // 특정 ROW 글자 크기 변경
                    this.FPS91_TY_S_US_963F6696.ActiveSheet.Rows[i].Font = new Font("굴림", 9, FontStyle.Bold);
                    this.FPS91_TY_S_US_963F6696.ActiveSheet.Rows[i].BackColor = Color.SkyBlue;
                }
            }
        }
        #endregion
        ...
        private void BTN61_PRT_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                SectionReport rpt = new TYUSME038R();
