            ...
            else if (this.CBO01_GGUBUN.GetText().ToString() == "거래명세서")
            {
                ...
                if (this.CBO01_GMEGUBUN.GetText().ToString() != "별첨화주")
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        if (this.CBO01_GMEGUBUN.GetText().ToString() == "시설사용료")
                        {
                            SectionReport rpt = new TYUSME017R1();
                        ...
                        {
                            SectionReport rpt = new TYUSME017R2();
                        ...
                        {
                            SectionReport rpt = new TYUSME017R3();
                        ...
                        {
                            SectionReport rpt = new TYUSME017R4();
                        ...
                        {
                            SectionReport rpt = new TYUSME017R5();
                        ...
                        else if (this.CBO01_GMEGUBUN.GetText().ToString() == "보관료")
                        {
                            ...
                            SectionReport rpt = new TYUSME017R6();
