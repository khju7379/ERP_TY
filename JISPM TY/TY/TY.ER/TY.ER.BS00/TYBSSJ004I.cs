...
namespace TY.ER.BS00
{
    ...
    ///  BSJYYMM : 실적생성년월
    /// </summary>
    public partial class TYBSSJ004I : TYBase
    {
        ...
        private void TYBSSJ004I_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_AC_79FED601", this.CBH01_BSJYYMM.GetValue().ToString(), CBH01_BCJDPAC.GetValue(), CBH01_BCJADAC.GetValue(), "CM");
        ...
        private string UP_Get_SJCheckClose()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                sYN = dt.Rows[0]["BLJCHKCM"].ToString();
            }
