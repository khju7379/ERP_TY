...
{
    /// <summary>
    /// 사업부 및 부서관리 복사 프로그램입니다.
    /// 
    /// 작성자 : 이상현
    /// 작성일 : 2017.07.27 17:55
    /// 
    /// =====================================================================================
    ...
    /// 
    /// # 프로시저 정보 ####
    ///  TY_P_AC_787BS359 : 사업부 및 부서관리 복사
    ///  TY_P_AC_787BT360 : 사업부 및 부서관리 복사체크
    ///  TY_P_AC_787BV361 : 부서별 임직원 관리 복사
    ///  TY_P_AC_787BV362 : 부서별 임직원 관리 복사체크
    /// 
    ///  # 스프레드 정보 ####
    /// 
    ///  # 알림문자 정보 ####
    ...
    ///  STDATE : 시작일자
    /// </summary>
    public partial class TYBSKB06C1 : TYBase
    {
        ...
        private void TYBSKB06C1_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_BATCH_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_AC_787BS359", this.DTP01_EDDATE.GetString().ToString().Substring(0, 4),
                                                        TYUserInfo.EmpNo,
                                                        this.DTP01_STDATE.GetString().ToString().Substring(0, 4));
            //this.DbConnector.ExecuteTranQueryList();

            //this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_AC_787BV361", this.DTP01_EDDATE.GetString().ToString().Substring(0, 4),
                                                        TYUserInfo.EmpNo,
                                                        this.DTP01_STDATE.GetString().ToString().Substring(0, 4));
            this.DbConnector.ExecuteTranQueryList();
        ...
        private void BTN61_BATCH_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_AC_787BT360", this.DTP01_EDDATE.GetString().ToString().Substring(0, 4));
            ...
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_AC_787BV362", this.DTP01_EDDATE.GetString().ToString().Substring(0, 4));
