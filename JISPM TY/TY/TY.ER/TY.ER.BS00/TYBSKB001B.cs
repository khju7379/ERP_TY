...
{
    /// <summary>
    /// 영업비용 세목코드 복사 프로그램입니다.
    /// 
    /// 작성자 : 이상현
    /// 작성일 : 2017.06.15 11:28
    /// 
    /// =====================================================================================
    ...
    /// 
    /// # 프로시저 정보 ####
    ///  TY_P_AC_76FBK811 : 영업비용 세목코드 복사
    ///  TY_P_AC_76FBQ812 : 영업비용 세목코드 삭제(년도별)
    /// 
    ///  # 스프레드 정보 ####
    /// 
    ///  # 알림문자 정보 ####
    ...
    ///  STDATE : 시작일자
    /// </summary>
    public partial class TYBSKB001B : TYBase
    {
        ...
        private void TYBSKB001B_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_BATCH_Click(object sender, EventArgs e)
        {
            ...
            //복사
            this.DbConnector.Attach("TY_P_AC_76FBK811", this.DTP01_EDDATE.GetString().ToString().Substring(0, 4),
                                                        TYUserInfo.EmpNo,
        ...
        private void BTN61_BATCH_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_AC_76FBQ812", this.DTP01_EDDATE.GetString().ToString().Substring(0, 4));
