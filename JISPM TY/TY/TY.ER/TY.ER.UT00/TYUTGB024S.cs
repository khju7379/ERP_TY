...
namespace TY.ER.UT00
{
    ...
    ///  PRM1020 : 년월
    /// </summary>
    public partial class TYUTGB024S : TYBase
    {
        ...
        private void TYUTGB024S_Load(object sender, System.EventArgs e)
        {
            this.FPS91_TY_S_UT_7B3FT936.Initialize();
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            if (this.CBH01_SHWAJU.GetValue().ToString() == "")
            {
                ...
                {
                    sProcedure = "TY_P_UT_7B3FT935";
                }
                else
                {
                    sProcedure = "TY_P_UT_7B3FT934";
                }
                ...
                this.FPS91_TY_S_UT_7B3FT936.SetValue(dt);
            }
            else
            {
                if (this.CBO01_GGUBUN.GetValue().ToString() == "1")
                {
                    sProcedure = "TY_P_UT_7B3G4938";
                }
                else
                {
                    sProcedure = "TY_P_UT_7B3G5939";
                }
