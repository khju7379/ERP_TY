...
namespace TY.ER.UT00
{
    ...
    ///  PRM1020 : 년월
    /// </summary>
    public partial class TYUTGB023S : TYBase
    {
        ...
        private void TYUTGB023S_Load(object sender, System.EventArgs e)
        {
            this.FPS91_TY_S_UT_777I9066.Initialize();

            this.BTN61_BATCH.ProcessCheck += new TButton.CheckHandler(BTN61_BATCH_ProcessCheck);

            this.DTP01_STDATE.SetValue(DateTime.Now.ToString("yyyy-MM-dd"));
            this.DTP01_EDDATE.SetValue(DateTime.Now.AddDays(7).ToString("yyyy-MM-dd"));
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.FPS91_TY_S_UT_777I9066.SetValue(dt);
        }
        #endregion
        ...
        private void BTN61_BATCH_Click(object sender, EventArgs e)
        {
            ...
            // TEMP 삭제
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_UT_77AB3073", sSSID.ToString());
            ...
            {
                // TEMP 등록
                this.DbConnector.Attach("TY_P_UT_77AB1072", sSSID.ToString(),
            ...
            // 지시 일괄 등록 SP 수행
            this.DbConnector.CommandClear();
            this.DbConnector.Attach("TY_P_UT_77AB4075", sSSID.ToString(),
        ...
        private void BTN61_BATCH_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            ds.Tables.Add(this.FPS91_TY_S_UT_777I9066.GetDataSourceInclude(TSpread.TActionType.Select, "IOIPDATE", "IOTKNO"));
