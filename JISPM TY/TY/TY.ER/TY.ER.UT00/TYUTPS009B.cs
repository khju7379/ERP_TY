...
namespace TY.ER.UT00
{
    ...
    ///  SDATE : 시작일자
    /// </summary>
    public partial class TYUTPS009B : TYBase
    {
        private string fsGMREDATE = string.Empty;

        #region Description : 페이지 로드
        public TYUTPS009B(string sGMREDATE)
        {
            InitializeComponent();
        ...
        private void TYUTPS009B_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_BATCH_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.DbConnector.Attach("TY_P_UT_B3UE4087",
