...
namespace TY.ER.UT00
{
    ...
    ///  SDATE : 시작일자
    /// </summary>
    public partial class TYUTPS007B : TYBase
    {
        private string fsGMREDATE = string.Empty;

        #region Description : 페이지 로드
        public TYUTPS007B(string sGMREDATE)
        {
            InitializeComponent();

            fsGMREDATE = sGMREDATE.ToString();
        }

        private void TYUTPS007B_Load(object sender, System.EventArgs e)
        {
            this.BTN61_BATCH.ProcessCheck += new TButton.CheckHandler(BTN61_BATCH_ProcessCheck);

            this.DTP01_STDATE.SetValue(Set_Date(fsGMREDATE.ToString()));
        ...
        private void BTN61_BATCH_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.DbConnector.Attach("TY_P_UT_B3JFP013",
