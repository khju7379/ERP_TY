...
namespace TY.ER.UT00
{
    ...
    ///  TY_P_UT_73LIV050 : 재고대장 조회 - 이고포함
    ///  TY_P_UT_73SGS121 : 총 탱크번호 조회(화주,화물)
    ///  TY_P_UT_73SHG122 : 총 입고,출고,할증량 조회(화주,화물,탱크번호)
    ///  TY_P_UT_73SHJ123 : 마지막 재고량 조회(화주,화물,탱크번호)
    ///  TY_P_UT_81FG3455 : 재고대장 조회 - 이고 미포함
    ///  TY_P_UT_8ACFZ941 : 마지막 재고량 조회(화주,화물,탱크번호) NEW
    ///  TY_P_UT_8AJA3989 : 재고대장 조회 - 이고포함 NEW
    /// 
    ///  # 스프레드 정보 ####
    ...
    ///  STDATE : 시작일자
    /// </summary>
    public partial class TYUTPR028B : TYBase
    {
        ...
        private void TYUTPR028B_Load(object sender, System.EventArgs e)
        {
        ...
        #region Description : 화물관리 버튼
        private void BTN61_HMBTN_Click(object sender, EventArgs e)
        {
            this.OpenModalPopup(new TYUTPR029I());
        }
        #endregion
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            if (this.CBO01_GGUBUN.GetValue().ToString() == "Y")
            {
                ...
                this.DbConnector.Attach("TY_P_UT_8B7FN105", sDATE,
            ...
            {
                this.DbConnector.Attach("TY_P_UT_8B8F2114", sDATE,
                                                            this.CBH01_CHHWAJU.GetValue().ToString(),
                                                            this.CBH01_CHHWAMUL.GetValue().ToString()
                                                            );
            }
        ...
        private void BTN61_PRT_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ActiveReport rpt = new TYUTPR002R();
                // 가로 출력
        ...
        private DataTable QueryDataSetReport(DataTable dt)
        {
            ...
            string sNEWJEHWAMUL2 = string.Empty;
            string sOLDJEHWAMUL2 = string.Empty;
            string sNEWHMDESC2 = string.Empty;
            string sOLDHMDESC2 = string.Empty;

            string sJEGUBUN = string.Empty;
            string sTANKNO = string.Empty;
            string sOLDTANKNO = string.Empty;
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                sNEWJEHWAMUL2 = dt.Rows[i]["JEHWAMUL2"].ToString();
                sNEWHMDESC2 = dt.Rows[i]["HMDESC2"].ToString();

                sTANKNO = dt.Rows[i]["JETANKNO"].ToString();
                ...
                if (i == 0)
                {
                    ...
                    sOLDJEHWAMUL2 = sNEWJEHWAMUL2.ToString();
                    sOLDHMDESC2 = sNEWHMDESC2.ToString();

                    sOLDTANKNO = sTANKNO.ToString();
                }
                ...
                if (dIPMTQTY + dIPKLQTY + dCHMTQTY + dCHKLQTY + dJEJEMT + dJEJEKL + dJEOVMT + dJEOVKL != 0)
                {
                    ...
                    if (sNEWJEHWAJU.ToString() == sOLDJEHWAJU.ToString())
                    {
                        ...
                        else  // 화물이 다를 경우
                        {
                            ...
                            if (sOLDJEHWAMUL == sOLDJEHWAMUL2)
                            {
                                this.DbConnector.Attach("TY_P_UT_8B7HB108", sOLDJEHWAJU,
                                                                            sOLDJEHWAMUL2
                                                                            );
                            ...
                            {
                                this.DbConnector.Attach("TY_P_UT_8B7GN106", sOLDJEHWAJU,
                                                                            sOLDJEHWAMUL2,
                                                                            sOLDTANKNO
                                                                            );
