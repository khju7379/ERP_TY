...
namespace TY.ER.UT00
{
    ...
    ///  STDATE : 시작일자
    /// </summary>
    public partial class TYUTPR026S : TYBase
    {
        ...
        private void TYUTPR026S_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.FPS91_TY_S_UT_7BTG5140.Initialize();
            ...
            if (this.CBH01_SHWAJU.GetValue().ToString() != "")
            {
                ...
                this.DbConnector.Attach("TY_P_UT_7BTG8138", this.DTP01_STDATE.GetString(),
            ...
            {
                this.DbConnector.Attach("TY_P_UT_7BTG9139", this.DTP01_STDATE.GetString(),
                                                            this.DTP01_EDDATE.GetString(),
                                                            this.CBH01_SHWAMUL.GetValue().ToString(),
                                                            this.CBH01_CHCHHJ.GetValue().ToString(),
                                                            this.TXT01_CHCARNO.GetValue().ToString(),
            ...
            this.FPS91_TY_S_UT_7BTG5140.SetValue(dt);

            for (int i = 0; i < FPS91_TY_S_UT_7BTG5140.CurrentRowCount; i++)
            {
                dCHMTQTY = dCHMTQTY + double.Parse(Get_Numeric(this.FPS91_TY_S_UT_7BTG5140.GetValue(i, "CHMTQTY").ToString()));
                dLTQTY   = dLTQTY   + double.Parse(Get_Numeric(this.FPS91_TY_S_UT_7BTG5140.GetValue(i, "LTQTY").ToString()));
            }
