...
namespace TY.ER.UT00
{
    ...
    /// </summary>
    public partial class TYUTME022R1 : DataDynamics.ActiveReports.ActiveReport
    {
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            if (fiCount > 0)
            {
                ...
                //else
                //{
                //    if (_dt.Rows[fiCount - 1]["EDBHWAMUL"].ToString() + _dt.Rows[fiCount - 1]["EDBCNT"].ToString() + _dt.Rows[fiCount - 1]["EDBHWAJU"].ToString() !=
                //        _dt.Rows[fiCount]["EDBHWAMUL"].ToString() + _dt.Rows[fiCount]["EDBCNT"].ToString() + _dt.Rows[fiCount]["EDBHWAJU"].ToString())
                //    {
                //        this.detail.NewPage = NewPage.Before;
                //    }
                //    else
