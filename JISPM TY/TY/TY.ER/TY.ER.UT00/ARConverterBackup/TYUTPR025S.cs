...
namespace TY.ER.UT00
{
    ...
    ///  STDATE : 시작일자
    /// </summary>
    public partial class TYUTPR025S : TYBase
    {
        ...
        private void TYUTPR025S_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_INQ_Click(object sender, EventArgs e)
        {
            ...
            this.FPS91_TY_S_UT_7BNG3114.Initialize();
            ...
            if (this.CBH01_SHWAJU.GetValue().ToString() != "")
            {
                ...
                this.DbConnector.Attach("TY_P_UT_7BNG0113", this.DTP01_STDATE.GetString(),
            ...
            {
                this.DbConnector.Attach("TY_P_UT_7BNGG117", this.DTP01_STDATE.GetString(),
                                                            this.DTP01_EDDATE.GetString(),
                                                            this.CBH01_SHWAMUL.GetValue().ToString(),
                                                            this.CBH01_CHCHHJ.GetValue().ToString(),
                                                            this.TXT01_CHCARNO.GetValue().ToString(),
            ...
            this.FPS91_TY_S_UT_7BNG3114.SetValue(dt);

            for (int i = 0; i < FPS91_TY_S_UT_7BNG3114.CurrentRowCount; i++)
            {
                dCHMTQTY = dCHMTQTY + double.Parse(Get_Numeric(this.FPS91_TY_S_UT_7BNG3114.GetValue(i, "CHMTQTY").ToString()));
                dLTQTY   = dLTQTY   + double.Parse(Get_Numeric(this.FPS91_TY_S_UT_7BNG3114.GetValue(i, "LTQTY").ToString()));
            }
        ...
        {
            this.OpenModalPopup(new TYUTPR033P());
        }
        #endregion
    }
}
