...
namespace TY.ER.UT00
{
    ...
    ///  SDATE : 시작일자
    /// </summary>
    public partial class TYUTPS001B : TYBase
    {
        private string fsRMREDATE = string.Empty;

        #region Description : 페이지 로드
        public TYUTPS001B(string sRMREDATE)
        {
            InitializeComponent();

            fsRMREDATE = sRMREDATE.ToString();
        }

        private void TYUTPS001B_Load(object sender, System.EventArgs e)
        {
            this.BTN61_BATCH.ProcessCheck += new TButton.CheckHandler(BTN61_BATCH_ProcessCheck);

            this.DTP01_STDATE.SetValue(Set_Date(fsRMREDATE.ToString()));
        ...
        private void BTN61_BATCH_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.DbConnector.Attach("TY_P_UT_B2JDK677",
