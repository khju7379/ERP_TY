...
namespace TY.ER.UT00
{
    ...
    ///  CHYMSEQ : 순번
    /// </summary>
    public partial class TYUTME015B : TYBase
    {
        ...
        private void TYUTME015B_Load(object sender, System.EventArgs e)
        {
        ...
        private void BTN61_CREATE_Click(object sender, EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_UT_73LCY029", Get_Date(this.DTP01_M1DATE.GetValue().ToString()),
        ...
        private void BTN61_CREATE_ProcessCheck(object sender, TButton.ClickEventCheckArgs e)
        {
            ...
            {
                // 20180126 하역료 매출생성시
                // 입고화물관리에 생성된 자료를 제외하고 생성되므로
                // 아래의 체크 뺌

                //// 하역료 매출 데이터 존재 체크
                //this.DbConnector.CommandClear();
                //this.DbConnector.Attach("TY_P_UT_73LHZ043", Get_Date(this.DTP01_M1DATE.GetValue().ToString()),
                //                                            Get_Date(this.DTP01_STDATE.GetValue().ToString()),
                //                                            Get_Date(this.DTP01_EDDATE.GetValue().ToString()),
                //                                            this.CBH01_M1BONSUN.GetValue().ToString(),
                //                                            this.CBH01_M1HWAJU.GetValue().ToString(),
                ...
                // 입고화물 데이터 존재 체크
                this.DbConnector.CommandClear();
                this.DbConnector.Attach("TY_P_UT_7B8DH960", Get_Date(this.DTP01_STDATE.GetValue().ToString()),
                                                            Get_Date(this.DTP01_EDDATE.GetValue().ToString()),
                                                            this.CBH01_M1BONSUN.GetValue().ToString(),
                                                            this.CBH01_M1HWAJU.GetValue().ToString(),
                                                            this.CBH01_M1HWAMUL.GetValue().ToString());
            ...
            else
            {
                ...
                // 하역료 매출 전표생성 데이터 존재 체크
                this.DbConnector.CommandClear();
                this.DbConnector.Attach("TY_P_UT_73LHZ044", Get_Date(this.DTP01_M1DATE.GetValue().ToString()),
                                                            Get_Date(this.DTP01_STDATE.GetValue().ToString()),
                                                            Get_Date(this.DTP01_EDDATE.GetValue().ToString()),
                                                            this.CBH01_M1BONSUN.GetValue().ToString(),
                                                            this.CBH01_M1HWAJU.GetValue().ToString(),
