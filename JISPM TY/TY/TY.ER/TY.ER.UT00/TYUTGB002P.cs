...
{
    public partial class TYUTGB002P : TYBase, IPopupHelper
    {
        ...
        public TYUTGB002P() : base()
        {
            InitializeComponent();

            this.SetPopupStyle();

            this.FormClosing += new FormClosingEventHandler(TYUTGB002P_FormClosing);
            this.PreLoad += new System.EventHandler(TYUTGB002P_PreLoad);
            this._favorItem.Click += new EventHandler(_favorItem_Click);
        }

        private void TYUTGB002P_PreLoad(object sender, System.EventArgs e)
        {
            //this._isShow = true;
        }

        private void TYUTGB002P_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.SaveSearchCondition();
            //this._isShow = false;
        }

        private void TYUTGB002P_Load(object sender, System.EventArgs e)
        {
            if (this.DesignMode)
                return;
        ...
        private void BTN61_INQ_Click(object sender, System.EventArgs e)
        {
            ...
            this.DbConnector.Attach("TY_P_UT_66DF5159", this.TXT01_CODE.GetValue(), this.TXT01_CODE_NAME.GetValue());
        ...
        public void ShowPopupHelper()
        {
            ...
            {
                this.TYUTGB002P_Load(null, null);
